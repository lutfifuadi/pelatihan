...
<div x-data="notificationBell()" class="notification-bell-container d-inline-block position-relative me-2">
    ...
    <div x-show="open"
        ...
        <div style="border-top: 1px solid rgba(255,255,255,0.06);">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->role === 'peserta'): ?>
            <a href="<?php echo e(route('dashboard.peserta.notifikasi')); ?>" 
...
<?php /**PATH D:\Project\Pelatihanku\resources\views/components/notification-bell.blade.php ENDPATH**/ ?>