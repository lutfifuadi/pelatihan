...
<?php $__env->startSection('title', 'Verifikasi Sertifikat'); ?>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-6">
        ...
        <div class="glass-card-premium p-4 mb-4">
          <form method="GET" action="<?php echo e(route('certificates.verify')); ?>">
            <div class="input-group">
              <input type="text" name="nomor" class="form-control" placeholder="Contoh: SERTIFIKAT/2026/06/ABC12345" value="<?php echo e($number ?? ''); ?>" required>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($number): ?>
              ...
              <div style="border-top: 1px solid rgba(255,255,255,0.08); padding-top: 20px;">
                <div class="row g-3">
                  <div class="col-6">
                    ...
                    <div class="info-value" style="font-family: monospace; color: #ffd700; font-size: 0.85rem;"><?php echo e($certificate->certificate_number); ?></div>
                  </div>
                  <div class="col-6">
                    <div class="info-label">Nama Peserta</div>
                    <div class="info-value"><?php echo e($certificate->enrollment->user->name); ?></div>
                  </div>
                  <div class="col-6">
                    <div class="info-label">Pelatihan</div>
                    <div class="info-value"><?php echo e($certificate->enrollment->pelatihan->nama); ?></div>
                  </div>
                  <div class="col-6">
                    <div class="info-label">Batch</div>
                    <div class="info-value"><?php echo e($certificate->enrollment->pelatihan->batch); ?></div>
                  </div>
                  <div class="col-6">
                    <div class="info-label">Tanggal Terbit</div>
                    <div class="info-value"><?php echo e($certificate->issued_at ? $certificate->issued_at->format('d F Y') : '-'); ?></div>
                  </div>
                  <div class="col-6">
            ...
            <?php else: ?>
              <div class="text-center">
                ...
                <p class="text-body-premium mt-2">
                  Tidak ada sertifikat dengan nomor <strong style="color: #f87171;"><?php echo e($number); ?></strong> di sistem kami.
...
<?php echo $__env->make('layouts/publicLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/public/verify-certificate.blade.php ENDPATH**/ ?>