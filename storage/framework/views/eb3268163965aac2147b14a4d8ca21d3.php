...
<?php $__env->startSection('title', __('Semua Pelatihan') . ' — ' . $institutionName); ?>
    ...
    <div class="container position-relative" style="z-index: 10;">
      <div class="row align-items-center">
        <div class="col-lg-8">
          ...
          <nav aria-label="Breadcrumb" class="mb-3">
            <ol class="breadcrumb-premium list-unstyled d-flex flex-wrap">
              <li><a href="<?php echo e(route('pages-home')); ?>#beranda"><i class="icon-base ti tabler-home me-1"></i>Beranda</a></li>
        ...
        <div class="col-lg-4 text-lg-end mt-4 mt-lg-0">
          <a href="<?php echo e(route('pages-home')); ?>#pelatihan" class="btn-back-home">
            ...
            <div class="col-md-6 col-lg-4 reveal" style="transition-delay: <?php echo e($loop->iteration * 0.1); ?>s;">
              <div class="pelatihan-card h-100">
                ...
                <div class="card-body">
                  ...
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isKuotaUnlimited && !$isDitutup): ?>
                    <div class="quota-bar">
                ...
                <div class="card-footer-action">
                  ...
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isDitutup): ?>
                  <button type="button" class="btn-ditutup-card" @click="open(<?php echo \Illuminate\Support\Js::from($pelatihan->nama)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($batchDisplay)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($pelatihan->batas_pendaftaran?->format('d/m/Y') ?? '-')->toHtml() ?>)">
                    <i class="icon-base ti tabler-ban me-1"></i> <?php echo e(__('Ditutup')); ?>

                  </button>
                  <?php else: ?>
                  <a href="<?php echo e(route('pages-home')); ?>#beranda" class="btn-daftar-card">
...
<?php echo $__env->make('layouts/publicLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/landing/pelatihan-index.blade.php ENDPATH**/ ?>