...
<div class="alert alert-success" role="alert" x-data="{ shown: false, timeout: null }" x-init="window.Livewire.find('<?php echo e($_instance->getId()); ?>').on('<?php echo e($on); ?>', () => {
...
<?php /**PATH D:\Project\Pelatihanku\resources\views/components/action-message.blade.php ENDPATH**/ ?>