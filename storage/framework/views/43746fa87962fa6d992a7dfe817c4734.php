    ...
    <div class="container-fluid d-flex justify-content-between align-items-center flex-wrap gap-2">
      <div class="d-flex align-items-center gap-2">
        ...
        <span class="fw-semibold small-mobile-text">
          <strong>MODE LOGIN AS:</strong> Anda saat ini masuk sebagai <strong><?php echo e(auth()->user()->name); ?></strong> (<?php echo e(ucfirst(auth()->user()->role)); ?>).
        </span>
      </div>
      <div>
        <form action="<?php echo e(route('impersonate.leave')); ?>" method="POST" class="m-0">
          <?php echo csrf_field(); ?>
...
<?php /**PATH D:\Project\Pelatihanku\resources\views/partials/impersonate-banner.blade.php ENDPATH**/ ?>