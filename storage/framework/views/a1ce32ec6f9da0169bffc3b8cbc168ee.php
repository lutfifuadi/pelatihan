  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
          ...
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <p class="text-body-premium mb-0 mt-1" style="font-size: 0.95rem;">
                Selamat datang kembali, <span class="text-gradient fw-extrabold"><?php echo e(auth()->user()->name); ?></span> 👋
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="row g-4 mb-4">
      ...
      <div class="col-lg-4 col-md-6 col-sm-6">
        <a href="<?php echo e(route('admin.pelatihan.index')); ?>" class="text-decoration-none">
          <div class="glass-card-premium px-4 py-4 h-100">
            <div class="d-flex align-items-center gap-3">
              ...
              <div>
                ...
                <h3 class="fw-bold text-white mb-0" id="stat-total-pelatihan"><?php echo e($totalPelatihan); ?></h3>
              </div>
            </div>
          </div>
        </a>
        ...
        <div class="glass-card-premium px-4 py-4 h-100">
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <h3 class="fw-bold text-white mb-0" id="stat-total-peserta"><?php echo e($userCounts->total_peserta); ?></h3>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="glass-card-premium px-4 py-4 h-100">
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <h3 class="fw-bold text-white mb-0" id="stat-total-instruktur"><?php echo e($userCounts->total_instruktur); ?></h3>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 col-md-6">
        <a href="<?php echo e(route('admin.koordinator.index')); ?>" class="text-decoration-none">
          <div class="glass-card-premium px-4 py-4 h-100">
            <div class="d-flex align-items-center gap-3">
              ...
              <div>
                ...
                <h3 class="fw-bold text-white mb-0" id="stat-total-koordinator"><?php echo e($userCounts->total_koordinator); ?></h3>
              </div>
            </div>
          </div>
        </a>
      ...
      <div class="col-lg-6 col-md-12">
        <a href="<?php echo e(route('admin.kecamatan.index')); ?>" class="text-decoration-none">
          <div class="glass-card-premium px-4 py-4 h-100">
            <div class="d-flex align-items-center gap-3">
              ...
              <div>
                ...
                <h3 class="fw-bold text-white mb-0" id="stat-total-kecamatan"><?php echo e($totalKecamatan); ?></h3>
              </div>
            </div>
          </div>
        </a>
    ...
    <div class="row g-4 mb-4">
      <div class="col-lg-3 col-md-6">
        <a href="<?php echo e(route('admin.notifications.index', ['channel' => 'whatsapp', 'status' => 'sent'])); ?>" class="text-decoration-none">
          <div class="glass-card-premium px-4 py-4 h-100">
            <div class="d-flex align-items-center gap-3">
              <div class="stat-icon-box stat-icon-success">
      ...
      <div class="col-lg-3 col-md-6">
        <a href="<?php echo e(route('admin.notifications.index', ['status' => 'failed'])); ?>" class="text-decoration-none">
          <div class="glass-card-premium px-4 py-4 h-100">
            <div class="d-flex align-items-center gap-3">
              <div class="stat-icon-box stat-icon-danger">
      ...
      <div class="col-lg-3 col-md-6">
        <a href="<?php echo e(route('admin.notification-templates.index', ['is_active' => 1])); ?>" class="text-decoration-none">
          <div class="glass-card-premium px-4 py-4 h-100">
            <div class="d-flex align-items-center gap-3">
              <div class="stat-icon-box stat-icon-primary">
      ...
      <div class="col-lg-3 col-md-6">
        <a href="<?php echo e(route('admin.notifications.index', ['status' => 'pending'])); ?>" class="text-decoration-none">
          <div class="glass-card-premium px-4 py-4 h-100">
            <div class="d-flex align-items-center gap-3">
              <div class="stat-icon-box stat-icon-warning">
      ...
      <div class="col-12 col-xl-8">
        <div class="glass-card-premium px-4 px-xl-5 py-4 h-100 d-flex flex-column">
          <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <a href="<?php echo e(route('admin.kecamatan.index')); ?>" class="btn btn-glow-premium btn-sm py-1 px-3">
      ...
      <div class="col-12 col-xl-4">
        <div class="glass-card-premium px-4 px-xl-5 py-4 h-100 d-flex flex-column">
          <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <span class="badge-premium badge-premium-primary" id="badge-active-pelatihan"><?php echo e($activePelatihanCount); ?> Aktif</span>
          </div>

          <div id="container-latest-pelatihan" class="d-flex flex-column h-100">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($latestPelatihan->isEmpty()): ?>
            ...
            <?php else: ?>
              <div class="d-flex flex-column gap-3 mb-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $latestPelatihan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="flex-grow-1">
                      <h6 class="text-white fw-semibold mb-0" style="font-size: 0.85rem;"><?php echo e($pel->nama); ?></h6>
                      <small class="text-body-premium">Batch <?php echo e($pel->batch); ?> • Kuota <?php echo e($pel->kuota); ?></small>
                    </div>
                    <div>
                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pel->is_active): ?>
              ...
              <div class="text-center mt-auto">
                <a href="<?php echo e(route('admin.pelatihan.index')); ?>" class="btn btn-glow-premium w-100 py-2">
      ...
      <div class="col-12 col-xl-6">
        <div class="glass-card-premium px-4 px-xl-5 py-4 h-100">
          <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <span class="badge-premium badge-premium-success" id="badge-peserta-count"><?php echo e($pesertaCount); ?> Peserta</span>
          </div>

          <div id="container-latest-peserta">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($latestPeserta->isEmpty()): ?>
            ...
            <?php else: ?>
              <div class="d-flex flex-column gap-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $latestPeserta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center gap-3">
                      ...
                      <div>
                        <h6 class="text-white fw-semibold mb-0" style="font-size: 0.85rem;"><?php echo e($p->name); ?></h6>
                        <small class="text-body-premium"><?php echo e($p->nik ?? 'NIK Tidak Tersedia'); ?></small>
                      </div>
                    </div>
                    <span class="text-body-premium small"><?php echo e($p->created_at->diffForHumans()); ?></span>
                  </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
              </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      ...
      <div class="col-12 col-xl-6">
        <div class="glass-card-premium px-4 px-xl-5 py-4 h-100">
          <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <span class="badge-premium badge-premium-info" id="badge-active-koors"><?php echo e($koorActiveCount); ?> Aktif</span>
          </div>

          <div id="container-active-koors">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeKoors->isEmpty()): ?>
              <div class="text-center py-4">
            ...
            <?php else: ?>
              <div class="d-flex flex-column gap-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $activeKoors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center gap-3">
                      <div class="instructor-avatar text-white" style="background: rgba(6, 182, 212, 0.15); color: #22d3ee;">
                        <?php echo e(strtoupper(substr($k->name, 0, 2))); ?>

                      </div>
                      <div>
                        <h6 class="text-white fw-semibold mb-0" style="font-size: 0.85rem;"><?php echo e($k->name); ?></h6>
                        <small class="text-body-premium">Kecamatan: <?php echo e($k->kecamatan->name ?? '-'); ?></small>
                      </div>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($k->whatsapp): ?>
                      <a href="https://wa.me/<?php echo e($k->whatsapp); ?>" target="_blank" class="btn btn-sm btn-outline-success px-2 py-1" style="border-radius: 4px; font-size: 11px;">
      ...
      <div class="col-12 col-xl-6">
        <div class="glass-card-premium px-4 px-xl-5 py-4 h-100">
          <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <span class="badge-premium badge-premium-warning" id="badge-pending-koordinator"><?php echo e($pendingKoordinatorCount); ?> Menunggu</span>
          </div>

          <div id="container-pending-koordinator">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingKoordinators->isEmpty()): ?>
              <div class="text-center py-5">
            ...
            <?php else: ?>
              <div class="table-responsive">
                <table class="table table-borderless text-white align-middle">
                  ...
                  <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $pendingKoordinators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $koor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.04);">
                        <td class="px-0 py-3">
                          <div class="fw-semibold text-white"><?php echo e($koor->name); ?></div>
                          <small class="text-body-premium"><?php echo e($koor->nik); ?></small>
                        </td>
                        <td class="py-3">
                          <span class="badge-premium badge-premium-info"><?php echo e($koor->kecamatan->name ?? '-'); ?></span>
                        </td>
                        <td class="py-3">
                          <a href="https://wa.me/<?php echo e($koor->whatsapp); ?>" target="_blank" class="text-warning text-decoration-none small">
                            <i class="icon-base ti tabler-brand-whatsapp me-1"></i><?php echo e($koor->whatsapp); ?>

                          </a>
                        </td>
                        <td class="text-end px-0 py-3">
                          <div class="d-inline-flex gap-2">
                            <form action="<?php echo e(route('admin.koordinator.approve', $koor->id)); ?>" method="POST">
                              <?php echo csrf_field(); ?>
                              <button type="submit" class="btn btn-success btn-sm px-3" style="border-radius: 5px;">
                                Approve
                              </button>
                            </form>
                            <form action="<?php echo e(route('admin.koordinator.reject', $koor->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menolak koordinator ini?')">
                              <?php echo csrf_field(); ?>
              ...
              <div class="text-center mt-3">
                <a href="<?php echo e(route('admin.koordinator.pending')); ?>" class="btn btn-glow-premium py-2 px-4 w-100">
      ...
      <div class="col-12 col-xl-6">
        <div class="glass-card-premium px-4 px-xl-5 py-4 h-100 d-flex flex-column">
          ...
          <div id="container-latest-activities" class="flex-grow-1">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($latestActivities->isEmpty()): ?>
              <div class="text-center py-5">
            ...
            <?php else: ?>
              <div class="d-flex flex-column gap-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $latestActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php
                  ...
                  <div class="d-flex align-items-start gap-3">
                    <span class="badge bg-<?php echo e($badgeColor); ?> bg-opacity-20 text-<?php echo e($badgeColor); ?> text-uppercase px-2 py-1 mt-1" style="font-size: 8px; border-radius: 4px; min-width: 65px; text-align: center;">
                      <?php echo e($log->action); ?>

                    </span>
                    <div class="flex-grow-1">
                      <p class="text-white mb-0" style="font-size: 0.85rem; line-height: 1.4;"><?php echo e($log->description); ?></p>
                      <small class="text-body-premium" style="font-size: 0.75rem;">
                        Oleh: <?php echo e($log->user->name ?? 'Sistem'); ?> • <?php echo e($log->created_at->diffForHumans()); ?>
...
<?php $__env->startSection('page-script'); ?>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      var sebaranKecamatan = <?php echo json_encode($sebaranKecamatan, 15, 512) ?>;
  ...
  <?php echo app('Illuminate\Foundation\Vite')(['resources/assets/js/dashboard-admin.js']); ?>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/dashboard/admin.blade.php ENDPATH**/ ?>