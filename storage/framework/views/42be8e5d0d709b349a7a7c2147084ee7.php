...
<?php $__env->startSection('title', 'Form Alamat & Kontak'); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$hasDataPribadi): ?>
...
<div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
  <div class="glass-card-dashboard text-center py-5" style="max-width: 520px; margin: 40px auto;">
    ...
    <a href="<?php echo e(route('dashboard.peserta.form-pendaftaran')); ?>" class="btn btn-glow fw-semibold py-2 px-4" style="border-radius: 5px; font-size: 13px;">
...
<div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1; margin-top: -1.5rem;">
  ...
  <div class="glass-card-dashboard" x-data="alamatForm()" x-cloak>
    ...
    <form id="formAlamat" action="<?php echo e(route('dashboard.peserta.form-alamat.store')); ?>" method="POST"
      @submit.prevent="if(validateForm()) { saving = true; $el.submit(); }">
      <?php echo csrf_field(); ?>

      <!-- Baris 1: Provinsi + Kota + Kecamatan (3 kolom sejajar) -->
      <div class="field-group-triple">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('provinsi', $akActive)): ?>
        <div>
          <label class="form-label form-label-custom" for="provinsi">
            <?php echo e($akLabels['provinsi'] ?? 'Provinsi'); ?>
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('kota', $akActive)): ?>
        <div>
          <label class="form-label form-label-custom" for="kota">
            <?php echo e($akLabels['kota'] ?? 'Kota/Kabupaten'); ?>
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('kecamatan_id', $akActive)): ?>
        <div>
          <label class="form-label form-label-custom" for="kecamatan_id">
            <?php echo e($akLabels['kecamatan_id'] ?? 'Kecamatan'); ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('kecamatan_id', $akRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          </label>
          <select id="kecamatan_id" name="kecamatan_id" class="form-control form-control-custom"
            ...
            <option value=""><?php echo e($akPlaceholders['kecamatan_id'] ?? 'PILIH KECAMATAN'); ?></option>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $kecamatans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($kec->id); ?>"><?php echo e(strtoupper($kec->name)); ?></option>
      ...
      <div class="field-group-quad mt-3">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('kelurahan_id', $akActive)): ?>
        <div>
          <label class="form-label form-label-custom" for="kelurahan_id">
            <?php echo e($akLabels['kelurahan_id'] ?? 'Kelurahan'); ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('kelurahan_id', $akRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          </label>
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('rt', $akActive)): ?>
        <div>
          <label class="form-label form-label-custom" for="rt">
            <?php echo e($akLabels['rt'] ?? 'RT'); ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('rt', $akRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          </label>
          <input type="text" id="rt" name="rt" class="form-control form-control-custom"
            x-model="form.rt" placeholder="<?php echo e($akPlaceholders['rt'] ?? 'RT'); ?>" maxlength="3"
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('rw', $akActive)): ?>
        <div>
          <label class="form-label form-label-custom" for="rw">
            <?php echo e($akLabels['rw'] ?? 'RW'); ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('rw', $akRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          </label>
          <input type="text" id="rw" name="rw" class="form-control form-control-custom"
            x-model="form.rw" placeholder="<?php echo e($akPlaceholders['rw'] ?? 'RW'); ?>" maxlength="3"
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('kodepos', $akActive)): ?>
        <div>
          <label class="form-label form-label-custom" for="kodepos">
            <?php echo e($akLabels['kodepos'] ?? 'Kode Pos'); ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('kodepos', $akRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          </label>
          <input type="text" id="kodepos" name="kodepos" class="form-control form-control-custom"
            x-model="form.kodepos" placeholder="<?php echo e($akPlaceholders['kodepos'] ?? 'KODE POS'); ?>"
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('alamat_ktp', $akActive)): ?>
      <div class="field-group mt-3">
        <div class="field-full">
          <label class="form-label form-label-custom" for="alamat_ktp">
            <?php echo e($akLabels['alamat_ktp'] ?? 'Nama Jalan/Gang'); ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('alamat_ktp', $akRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          </label>
          <input type="text" id="alamat_ktp" name="alamat_ktp" class="form-control form-control-custom form-control-uppercase"
            x-model="form.alamat_ktp" placeholder="<?php echo e($akPlaceholders['alamat_ktp'] ?? 'NAMA JALAN/GANG'); ?>"
      ...
      <div class="field-group mt-3">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('whatsapp', $akActive)): ?>
        <div>
          <label class="form-label form-label-custom" for="whatsapp">
            <?php echo e($akLabels['whatsapp'] ?? 'Nomor WhatsApp'); ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('whatsapp', $akRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          </label>
          <input type="tel" id="whatsapp" name="whatsapp" class="form-control form-control-custom"
            x-model="form.whatsapp" placeholder="<?php echo e($akPlaceholders['whatsapp'] ?? '08XXXXXXXXXX'); ?>"
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('email', $akActive)): ?>
        <div>
          <label class="form-label form-label-custom" for="email">
            <?php echo e($akLabels['email'] ?? 'Email'); ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('email', $akRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          </label>
          <input type="email" id="email" name="email" class="form-control form-control-custom"
            x-model="form.email" placeholder="<?php echo e($akPlaceholders['email'] ?? 'CONTOH@EMAIL.COM'); ?>"
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('link_medsos', $akActive)): ?>
      <div class="field-group mt-3">
        <div class="field-full">
          <label class="form-label form-label-custom">
            <?php echo e($akLabels['link_medsos'] ?? 'Link Media Sosial'); ?>
          ...
          <template x-for="(medsos, index) in form.medsos_list" :key="index">
            <div class="d-flex align-items-center gap-2 mb-2">
              <select x-model="medsos.platform" class="form-control form-control-custom" style="width: 140px; flex-shrink: 0;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $platList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <button type="button" class="btn btn-sm mt-1" style="background: rgba(99,102,241,0.1); border: 1px dashed rgba(99,102,241,0.3); color: #818cf8; border-radius: 5px; padding: 6px 14px; font-size: 12px;"
            @click="form.medsos_list.push({platform: '<?php echo e(collect($platList)->keys()->first() ?? 'Instagram'); ?>', url: ''})">
      ...
      <div class="d-flex justify-content-between mt-4">
        <a href="<?php echo e(route('dashboard.peserta.form-pendaftaran')); ?>" class="btn btn-glow-outline fw-semibold py-2 px-4" style="border-radius: 5px; font-size: 13px; text-decoration: none;">
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/dashboard/peserta/form-alamat.blade.php ENDPATH**/ ?>