  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
    ...
    <div class="glass-card-premium px-4 px-xl-5 py-4 mb-4">
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <a href="<?php echo e(route('admin.notification-templates.create')); ?>" class="btn btn-glow-premium px-4 py-2 d-flex align-items-center gap-2">
    ...
    <div class="col-12">
      <div class="glass-card-premium px-4 py-4">
            ...
            <tbody>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.04);">
                  <td class="px-0 py-3">
                    <code class="text-info" style="background: rgba(6,182,212,0.1); padding: 2px 8px; border-radius: 3px; font-size: 12px;"><?php echo e($template->key); ?></code>
                  </td>
                  <td class="py-3 fw-semibold text-white"><?php echo e($template->name); ?></td>
                  <td class="py-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($template->channel == 'whatsapp'): ?>
                    ...
                    <?php elseif($template->channel == 'email'): ?>
                  ...
                  <td class="text-end px-0 py-3">
                    <div class="d-inline-flex gap-2">
                      <a href="<?php echo e(route('admin.notification-templates.edit', $template)); ?>" class="btn btn-warning btn-sm d-flex align-items-center justify-content-center"
                        style="border-radius: 5px; width: 32px; height: 32px; padding: 0;" title="Edit">
                        <i class="icon-base ti tabler-edit fs-5 text-dark"></i>
                      </a>
                      <form action="<?php echo e(route('admin.notification-templates.test', $template)); ?>" method="POST" class="d-inline">
                        <?php echo csrf_field(); ?>
                      ...
                      <form action="<?php echo e(route('admin.notification-templates.destroy', $template)); ?>" method="POST" class="d-inline"
                        onsubmit="return confirm('Yakin ingin menghapus template <?php echo e($template->name); ?>?')">
                        <?php echo csrf_field(); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($templates->hasPages()): ?>
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/admin/notifications/templates/index.blade.php ENDPATH**/ ?>