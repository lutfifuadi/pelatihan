    ...
    <div class="glass-card-premium px-4 px-xl-5 py-4 mb-4">
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div class="d-flex align-items-center gap-2">
          <a href="<?php echo e(route('admin.exports.peserta.pdf')); ?>" class="btn btn-outline-info btn-sm" style="border-radius: 5px; border-color: rgba(96,165,250,0.3); color: #93c5fd; font-weight: 600; padding: 4px 12px; font-size: 0.75rem; transition: all 0.3s ease;">
            <i class="icon-base ti tabler-file-export me-1"></i> 📄 Export PDF
          </a>
          <a href="<?php echo e(route('admin.exports.peserta.excel')); ?>" class="btn btn-outline-success btn-sm" style="border-radius: 5px; border-color: rgba(16,185,129,0.3); color: #34d399; font-weight: 600; padding: 4px 12px; font-size: 0.75rem; transition: all 0.3s ease;">
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="position-relative flex-grow-1">
            ...
            <input type="text" id="search-input"
              class="form-control" placeholder="Cari nama, NIK, atau WA..." value="<?php echo e($search ?? ''); ?>" style="padding-left: 2.5rem !important; border-radius: 5px;">
          </div>
          <div style="min-width: 200px;">
            <select id="filter-pelatihan-select" class="form-select text-white" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 5px; height: 42px; padding: 0 14px;">
              <option value="all" <?php echo e(($filterPelatihan ?? 'all') == 'all' ? 'selected' : ''); ?> style="background-color: #0b0f19;">Semua Status Pelatihan</option>
              <option value="sudah" <?php echo e(($filterPelatihan ?? 'all') == 'sudah' ? 'selected' : ''); ?> style="background-color: #0b0f19;">Sudah Memilih Pelatihan</option>
              <option value="belum" <?php echo e(($filterPelatihan ?? 'all') == 'belum' ? 'selected' : ''); ?> style="background-color: #0b0f19;">Belum Memilih Pelatihan</option>
            </select>
          </div>
          <a href="<?php echo e(route('admin.peserta.index')); ?>" id="reset-btn" class="btn btn-secondary-custom px-3 py-2 <?php echo e((request()->has('search') && request('search') != '') || (request()->has('filter_pelatihan') && request('filter_pelatihan') != 'all') ? '' : 'd-none'); ?>" style="white-space: nowrap;">
        ...
        <div class="table-responsive">
          <table class="table table-borderless text-white align-middle">
              ...
              <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.08);">
                ...
                <th class="text-body-premium small fw-semibold" style="cursor: pointer;" id="sort-name">
                  <span class="d-flex align-items-center gap-1">
                    Nama
                    <i id="sort-icon" class="icon-base ti <?php echo e($sortBy == 'name' ? ($sortDir == 'asc' ? 'tabler-sort-ascending' : 'tabler-sort-descending') : 'tabler-arrows-sort'); ?>" style="font-size: <?php echo e($sortBy == 'name' ? '1rem' : '0.85rem'); ?>;"></i>
                  </span>
                </th>
            ...
            <tbody id="table-content">
              <?php echo $__env->make('content.admin.peserta._table_rows', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </tbody>
          </table>
        </div>
...
<script>
  (function() {
    ...
    let sortBy = <?php echo json_encode($sortBy); ?>;
    let sortDir = <?php echo json_encode($sortDir); ?>;
    let filterPelatihan = <?php echo json_encode($filterPelatihan ?? 'all'); ?>;
    let loading = false;
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/admin/peserta/index.blade.php ENDPATH**/ ?>