...
<?php $__env->startSection('title', 'Daftar FAQ'); ?>
      ...
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div class="d-flex align-items-center gap-3">
          <div class="stat-icon-box stat-icon-primary">
            <i class="icon-base ti tabler-help-circle fs-4"></i>
          </div>
          <div>
            <h4 class="fw-bold text-white mb-0">Daftar FAQ</h4>
            <p class="text-body-premium mb-0 mt-1" style="font-size: 0.95rem;">
              Kelola pertanyaan dan jawaban yang sering ditanyakan
            </p>
          </div>
        </div>
        <a href="<?php echo e(route('admin.faqs.create')); ?>" class="btn btn-glow-premium px-4 py-2 d-flex align-items-center gap-2">
          <i class="icon-base ti tabler-plus"></i> Tambah FAQ
        </a>
      </div>
    </div>
          ...
          <table class="table table-borderless text-white align-middle">
            <thead>
              <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.08);">
                ...
                <th class="text-body-premium small fw-semibold" style="width: 80px;">Urutan</th>
                <th class="text-body-premium small fw-semibold">Pertanyaan</th>
                <th class="text-body-premium small fw-semibold" style="width: 100px;">Status</th>
            ...
            <tbody>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.04);">
                  <td class="px-0 py-3 text-body-premium"><?php echo e($index + 1); ?></td>
                  <td class="py-3">
                    <span class="badge-premium"><?php echo e($faq->order); ?></span>
                  </td>
                  <td class="py-3 text-white fw-semibold"><?php echo e(\Illuminate\Support\Str::limit($faq->question, 60)); ?></td>
                  <td class="py-3">
                  ...
                  <td class="text-end px-0 py-3">
                    <div class="d-inline-flex gap-2">
                      <a href="<?php echo e(route('admin.faqs.edit', $faq)); ?>" class="btn btn-warning btn-sm d-flex align-items-center justify-content-center" style="border-radius: 5px; width: 32px; height: 32px; padding: 0;">
              ...
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr>
                  <td colspan="5" class="text-center text-body-premium py-5">
                    <i class="icon-base ti tabler-help-off fs-1 mb-2 d-block text-warning"></i>
                    Belum ada data FAQ.
                  </td>
                </tr>
              <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/admin/faqs/index.blade.php ENDPATH**/ ?>