...
<?php $__env->startSection('title', 'Review Data Pendaftaran'); ?>
...
<div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
  ...
  <div x-data="reviewForm()" x-cloak>
    <form id="formReview" action="<?php echo e(route('dashboard.peserta.form-review.submit')); ?>" method="POST">
      <?php echo csrf_field(); ?>
      ...
      <div class="review-card">
        <div class="review-card-header">
          ...
          <a href="<?php echo e(route('dashboard.peserta.form-pendaftaran')); ?>" class="edit-btn">
        ...
        <div class="data-grid">
          <div class="data-item">
            ...
            <span class="data-value"><?php echo e($allData['nama_lengkap'] ?? $profile->nama_lengkap ?? '-'); ?></span>
          </div>
          <div class="data-item">
            <span class="data-label">Jenis Kelamin</span>
            <span class="data-value"><?php echo e($allData['jenis_kelamin'] ?? $profile->jenis_kelamin ?? '-'); ?></span>
          </div>
          <div class="data-item">
            <span class="data-label">Tempat Lahir</span>
            <span class="data-value"><?php echo e($allData['tempat_lahir'] ?? $profile->tempat_lahir ?? '-'); ?></span>
          </div>
          <div class="data-item">
            <span class="data-label">Tanggal Lahir</span>
            <span class="data-value"><?php echo e(($allData['tanggal_lahir'] ?? $profile->tanggal_lahir ?? '-') . ' ' . ($allData['bulan_lahir'] ?? $profile->bulan_lahir ?? '') . ' ' . ($allData['tahun_lahir'] ?? $profile->tahun_lahir ?? '')); ?></span>
          </div>
          <div class="data-item full-width">
            <span class="data-label">NIK</span>
            <span class="data-value"><?php echo e($allData['nik'] ?? $profile->nik ?? '-'); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="review-card">
        <div class="review-card-header">
          ...
          <a href="<?php echo e(route('dashboard.peserta.form-alamat')); ?>" class="edit-btn">
            <i class="icon-base ti tabler-pencil"></i> Ubah
          </a>
        </div>
        <div class="data-grid">
          <div class="data-item full-width">
            ...
            <span class="data-value"><?php echo e($allData['alamat_ktp'] ?? $profile->alamat_ktp ?? '-'); ?></span>
          </div>
          <div class="data-item">
            <span class="data-label">RT / RW</span>
            <span class="data-value"><?php echo e(($allData['rt'] ?? $profile->rt ?? '-') . ' / ' . ($allData['rw'] ?? $profile->rw ?? '-')); ?></span>
          </div>
          <div class="data-item">
            <span class="data-label">Kelurahan</span>
            <span class="data-value"><?php echo e($profile->kelurahan ?? '-'); ?></span>
          </div>
          <div class="data-item">
            <span class="data-label">Kecamatan</span>
            <span class="data-value"><?php echo e($allData['kecamatan_id'] ?? $profile->kecamatan ?? '-'); ?></span>
          </div>
          <div class="data-item">
            <span class="data-label">Kota</span>
            <span class="data-value"><?php echo e($allData['kota'] ?? $profile->kota ?? '-'); ?></span>
          </div>
          <div class="data-item">
            <span class="data-label">Provinsi</span>
            <span class="data-value"><?php echo e($allData['provinsi'] ?? $profile->provinsi ?? '-'); ?></span>
          </div>
          <div class="data-item">
            <span class="data-label">Kode Pos</span>
            <span class="data-value"><?php echo e($allData['kodepos'] ?? $profile->kodepos ?? '-'); ?></span>
          </div>
          <div class="data-item">
            <span class="data-label">WhatsApp</span>
            <span class="data-value"><?php echo e($allData['whatsapp'] ?? $profile->whatsapp ?? '-'); ?></span>
          </div>
          <div class="data-item">
            <span class="data-label">Email</span>
            <span class="data-value"><?php echo e($allData['email'] ?? $profile->email ?? '-'); ?></span>
          </div>
          <div class="data-item full-width">
            ...
            <span class="data-value">
              ...
              ?>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($linkMedsos) && is_array($linkMedsos)): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $linkMedsos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medsos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div style="font-size: 12px;"><?php echo e(($medsos['platform'] ?? '') . ': ' . ($medsos['url'] ?? '')); ?></div>
      ...
      <div class="review-card">
        <div class="review-card-header">
          ...
          <a href="<?php echo e(route('dashboard.peserta.form-pendidikan')); ?>" class="edit-btn">
            <i class="icon-base ti tabler-pencil"></i> Ubah
          </a>
        </div>
        <div class="data-grid">
          <div class="data-item full-width">
            ...
            <span class="data-value"><?php echo e($allData['pendidikan_terakhir'] ?? $profile->pendidikan_terakhir ?? '-'); ?></span>
          </div>
          <div class="data-item">
            <span class="data-label">Institusi</span>
            <span class="data-value"><?php echo e($allData['nama_institusi'] ?? $profile->nama_institusi ?? '-'); ?></span>
          </div>
          <div class="data-item">
            <span class="data-label">Jurusan</span>
            <span class="data-value"><?php echo e($allData['jurusan'] ?? $profile->jurusan ?? '-'); ?></span>
          </div>
          <div class="data-item">
            <span class="data-label">Tahun Lulus</span>
            <span class="data-value"><?php echo e($allData['tahun_lulus'] ?? $profile->tahun_lulus ?? '-'); ?></span>
          </div>
          <div class="data-item">
            <span class="data-label">Status Pekerjaan</span>
            <span class="data-value"><?php echo e($allData['status_pekerjaan'] ?? $profile->status_pekerjaan ?? '-'); ?></span>
          </div>
          <?php $statusPekerjaan = $allData['status_pekerjaan'] ?? $profile->status_pekerjaan ?? ''; ?>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statusPekerjaan === 'BEKERJA' || $statusPekerjaan === 'Bekerja'): ?>
          <div class="data-item full-width">
            <span class="data-label">Nama Perusahaan</span>
            <span class="data-value"><?php echo e($allData['nama_perusahaan'] ?? $profile->nama_perusahaan ?? '-'); ?></span>
          </div>
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
      </div>
      ...
      <div class="review-card">
        <div class="review-card-header">
          ...
          <a href="<?php echo e(route('dashboard.peserta.form-minat')); ?>" class="edit-btn">
            <i class="icon-base ti tabler-pencil"></i> Ubah
          </a>
        </div>
        <div class="data-grid">
          <div class="data-item full-width">
            ...
            <span class="data-value"><?php echo e($allData['batch_pelatihan'] ?? $profile->batch_pelatihan ?? '-'); ?></span>
          </div>
          ...
          <div class="data-item full-width">
            ...
            <span class="data-value"><?php echo e($allData['batch_pelatihan'] ?? $profile->batch_pelatihan ?? '-'); ?> : <?php echo e($profile->pelatihan->nama ?? '-'); ?></span>
          </div>
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          <div class="data-item full-width">
            <span class="data-label">Dinas Pelaksana</span>
            <span class="data-value"><?php echo e($profile->pelatihan->dinas->nama_dinas ?? '-'); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="review-card">
        <div class="review-card-header">
          ...
          <a href="<?php echo e(route('dashboard.peserta.form-dokumen')); ?>" class="edit-btn">
            <i class="icon-base ti tabler-pencil"></i> Ubah
          </a>
        </div>
        <div>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($jawaban)): ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $jawaban; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              ?>
              <div class="qa-item">
                <div class="qa-question"><?php echo e($label); ?></div>
                <div class="qa-answer <?php echo e(empty($value) ? 'empty' : ''); ?>">
                  <?php echo e(!empty($value) ? $value : '(Tidak diisi)'); ?>
      ...
      <div class="d-flex justify-content-between mt-4">
        <a href="<?php echo e(route('dashboard.peserta.form-dokumen')); ?>" class="btn btn-glow-outline fw-semibold py-2 px-4" style="border-radius: 5px; font-size: 13px;">
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/dashboard/peserta/form-review.blade.php ENDPATH**/ ?>