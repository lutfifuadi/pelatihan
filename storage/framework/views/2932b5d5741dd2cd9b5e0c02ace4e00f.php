...
<?php $__env->startSection('title', 'Edit Template Notifikasi'); ?>
  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
    ...
    <div class="glass-card-premium px-4 px-xl-5 py-4 mb-4">
      <div class="d-flex align-items-center gap-3">
        ...
        <div>
          <h4 class="fw-bold text-white mb-0">Edit Template: <?php echo e($template->name); ?></h4>
          <p class="text-body-premium mb-0 mt-1" style="font-size: 0.95rem;">
            Ubah template notifikasi
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="col-12">
      <div class="glass-card-premium px-4 px-xl-5 py-5">
        <div class="row">
          <div class="col-lg-8">
            <form action="<?php echo e(route('admin.notification-templates.update', $template)); ?>" method="POST">
              <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                  id="key" name="key" value="<?php echo e(old('key', $template->key)); ?>"
                  placeholder="contoh: welcome_peserta" required readonly
                  style="opacity: 0.6; cursor: not-allowed;">
                <small class="text-body-premium mt-1 d-block" style="font-size: 0.75rem;">
                  <i class="icon-base ti tabler-info-circle me-1"></i>Key tidak dapat diubah setelah dibuat
                </small>
...
unset($__errorArgs, $__bag); ?>"
                  id="name" name="name" value="<?php echo e(old('name', $template->name)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                  id="title" name="title" value="<?php echo e(old('title', $template->title)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                  ...
                  placeholder="Tulis isi pesan. Gunakan {placeholder} untuk variabel dinamis." required><?php echo e(old('body', $template->body)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="channel" name="channel" required>
                    <option value="">-- Pilih Channel --</option>
                    <option value="whatsapp" <?php if(old('channel', $template->channel) == 'whatsapp'): echo 'selected'; endif; ?>>WhatsApp</option>
                    <option value="email" <?php if(old('channel', $template->channel) == 'email'): echo 'selected'; endif; ?>>Email</option>
                    <option value="in_app" <?php if(old('channel', $template->channel) == 'in_app'): echo 'selected'; endif; ?>>In-App</option>
                  </select>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
              ...
              <div class="d-flex justify-content-end gap-3 mt-5">
                <a href="<?php echo e(route('admin.notification-templates.index')); ?>" class="btn btn-secondary-custom px-4 py-2">
                  Batal
                </a>
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/admin/notifications/templates/edit.blade.php ENDPATH**/ ?>