...
<?php $__env->startSection('title', __('Pendaftaran Pelatihan Ekonomi Kreatif') . ' 2026'); ?>
...
<div id="beranda-page-wrapper">
  ...
  <?php echo $__env->make('partials.floating-navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      ...
      <div class="row align-items-center justify-content-between py-lg-4 py-0 mt-3 mt-lg-0">
        ...
        <div class="col-lg-6 text-center text-lg-start mb-5 mb-lg-0">
          ...
          <h1 class="display-4 fw-bold text-white mb-4 hero-title" style="line-height: 1.15; font-family: 'Sora', sans-serif;">
            <?php echo e($hero_title); ?><br/>
            <span class="text-warning text-gradient-creative"><?php echo e($hero_subtitle); ?></span><br/>
          </h1>

          <!-- Body Description -->
          <p class="text-white-50 fs-5 mb-4 lh-lg" style="max-width: 560px;">
            <?php echo e($hero_description); ?>
          ...
          <div class="d-flex flex-wrap gap-3 mb-5 justify-content-center justify-content-lg-start">
            <div class="benefit-badge">
              <i class="icon-base ti tabler-<?php echo e($hero_tag_1_icon); ?> fs-5 text-warning"></i>
              <span><?php echo e($hero_tag_1_text); ?></span>
            </div>
            <div class="benefit-badge">
              <i class="icon-base ti tabler-<?php echo e($hero_tag_2_icon); ?> fs-5 text-warning"></i>
              <span><?php echo e($hero_tag_2_text); ?></span>
            </div>
            <div class="benefit-badge">
              <i class="icon-base ti tabler-<?php echo e($hero_tag_3_icon); ?> fs-5 text-warning"></i>
              <span><?php echo e($hero_tag_3_text); ?></span>
            </div>
          </div>
          ...
          <div class="row g-4 pt-4 border-top border-white-subtle" style="border-top: 1px solid rgba(255, 255, 255, 0.08) !important;">
            <div class="col-4 col-sm-4">
              <div class="text-white fw-bold display-6" style="font-family: 'Sora', sans-serif;"><?php echo e($hero_stat_1_value); ?></div>
              <div class="text-white-50 small"><?php echo e($hero_stat_1_label); ?></div>
            </div>
            <div class="col-4 col-sm-4">
              <div class="text-white fw-bold display-6 text-gradient-creative" style="font-family: 'Sora', sans-serif;"><?php echo e($hero_stat_2_value); ?></div>
              <div class="text-white-50 small"><?php echo e($hero_stat_2_label); ?></div>
            </div>
            <div class="col-4 col-sm-4">
              <div class="text-white fw-bold display-6" style="font-family: 'Sora', sans-serif;"><?php echo e($hero_stat_3_value); ?></div>
              <div class="text-white-50 small"><?php echo e($hero_stat_3_label); ?></div>
            </div>
          </div>

          <!-- Bottom Floating Scroll Indicator -->
          <div class="d-none d-lg-flex align-items-center text-white-50 mt-5 pt-3" style="opacity: 0.45;">
            <span class="me-3 small"><?php echo e($hero_scroll_text); ?></span>
          ...
          <div class="glass-card-premium px-4 px-xl-5 py-4">
            ...
            <div class="alert alert-success alert-dismissible fade show mb-4 border-0" role="alert" style="background: linear-gradient(135deg, #10b981, #059669); color: white; border-radius: 5px;">
              <div class="d-flex align-items-center">
                ...
                <span class="small fw-semibold"><?php echo e(session('success')); ?></span>
              </div>
            ...
            <form id="formRegistration" action="<?php echo e(route('landing.register')); ?>" method="POST" novalidate>
              <?php echo csrf_field(); ?>

              <!-- Input Nama — Full width, auto uppercase -->
              <div class="mb-3">
                <label for="name" class="form-label form-label-custom"><?php echo e(__('Nama Lengkap (Sesuai KTP)')); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                  placeholder="Contoh: ANDI PRATAMA" value="<?php echo e(old('name')); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
              ...
              <div class="row mb-3">
                <div class="col-md-6 mb-3 mb-md-0">
                  <label for="nik" class="form-label form-label-custom"><?php echo e(__('NIK (Nomor Induk Kependudukan)')); ?></label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-md-6">
                  <label for="email" class="form-label form-label-custom"><?php echo e(__('Alamat Email')); ?></label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
              ...
              <div class="mb-3">
                <label for="whatsapp" class="form-label form-label-custom"><?php echo e(__('Nomor WhatsApp Aktif')); ?></label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
              ...
              <div class="d-flex align-items-start gap-2 mb-3 p-3" style="background: rgba(255, 193, 7, 0.08); border: 1px solid rgba(255, 193, 7, 0.15); border-radius: 5px;">
                ...
                <div>
                  <p class="small text-white-50 mb-0" style="line-height: 1.45;">
                    <?php echo e($form_password_info); ?>.
                    <span class="text-warning fw-semibold"><?php echo e($form_password_value); ?></span>
                  </p>
                </div>
              </div>
              ...
              <button type="submit" id="btnDaftar" class="btn btn-warning btn-lg w-100 fw-semibold btn-glow py-3" style="font-family: 'Sora', sans-serif; border-radius: 5px;">
                <span id="btn-text"><?php echo e($form_button_text); ?> <i class="icon-base ti tabler-arrow-right ms-2"></i></span>
                <span id="btn-loading" class="d-none">
                  <span class="spinner-border spinner-border-sm me-2" role="status"></span>
                  <?php echo e($form_button_loading); ?>
              ...
              <p class="text-center mt-3 mb-0">
                <span class="text-white-50 small"><?php echo e($form_login_text); ?> </span>
                <a href="<?php echo e(route('login')); ?>" class="small fw-semibold text-warning text-decoration-none hover-white"><?php echo e($form_login_link); ?></a>
              </p>
            </form>
          </div>
        </div>
    ...
    <div class="container py-4">
      ...
      <div class="text-center mb-5 pb-3 reveal">
        <span class="badge bg-primary bg-opacity-10 text-primary px-4 py-2 fw-semibold mb-3" style="font-size: 0.8rem; letter-spacing: 0.05em; border-radius: 5px;">
          <?php echo e(strtoupper($steps_badge)); ?>

        </span>
        <h2 class="fw-bold mb-3 display-6" style="color: #0b0f19;"><?php echo e($steps_title); ?></h2>
        <p class="text-muted fs-5 mx-auto" style="max-width: 520px;">
          <?php echo e($steps_subtitle); ?>
      ...
      <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-4 reveal" style="transition-delay: 0.1s;">
          <div class="step-card-premium">
            <span class="step-number-pill"><?php echo e(__('Langkah')); ?> 01</span>
            <div class="step-icon-glow">
              <i class="icon-base ti tabler-user-check"></i>
            </div>
            <h5 class="fw-bold mt-0 mb-3" style="color: #0b0f19; font-family: 'Sora', sans-serif;"><?php echo e($steps_1_title); ?></h5>
            <p class="text-muted mb-0" style="font-size: 0.95rem; line-height: 1.6;">
              <?php echo e($steps_1_desc); ?>
        ...
        <div class="col-md-4 reveal" style="transition-delay: 0.2s;">
          <div class="step-card-premium">
            <span class="step-number-pill"><?php echo e(__('Langkah')); ?> 02</span>
            <div class="step-icon-glow">
              <i class="icon-base ti tabler-school"></i>
            </div>
            <h5 class="fw-bold mt-0 mb-3" style="color: #0b0f19; font-family: 'Sora', sans-serif;"><?php echo e($steps_2_title); ?></h5>
            <p class="text-muted mb-0" style="font-size: 0.95rem; line-height: 1.6;">
              <?php echo e($steps_2_desc); ?>
        ...
        <div class="col-md-4 reveal" style="transition-delay: 0.3s;">
          <div class="step-card-premium">
            <span class="step-number-pill"><?php echo e(__('Langkah')); ?> 03</span>
            <div class="step-icon-glow">
              <i class="icon-base ti tabler-award"></i>
            </div>
            <h5 class="fw-bold mt-0 mb-3" style="color: #0b0f19; font-family: 'Sora', sans-serif;"><?php echo e($steps_3_title); ?></h5>
            <p class="text-muted mb-0" style="font-size: 0.95rem; line-height: 1.6;">
              <?php echo e($steps_3_desc); ?>
  ...
  <section id="pelatihan" class="py-8 py-lg-10 pelatihan-grid-section">
    <div class="container py-4 position-relative" style="z-index: 1;">
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pelatihans->count() > 0): ?>
        <div class="row g-4">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $pelatihans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pelatihan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <div class="col-md-6 col-lg-4 reveal" style="transition-delay: <?php echo e($loop->iteration * 0.1); ?>s;">
              <div class="pelatihan-card h-100">
                <!-- Cover Image -->
                <div class="card-cover">
                  <img src="<?php echo e($coverUrl); ?>" alt="<?php echo e($pelatihan->nama); ?>" loading="lazy">
                  <span class="card-badge-category"><?php echo e($imageKey); ?></span>
                  <span class="card-badge-status <?php echo e($statusClass); ?>"><?php echo e($statusText); ?></span>
                </div>

                <!-- Card Body -->
                <div class="card-body">
                  <div class="batch-label"><?php echo e(__('Batch')); ?> <?php echo e($batchDisplay); ?></div>
                  <h5 class="card-title"><?php echo e($pelatihan->nama); ?></h5>

                  <div class="card-meta">
                    <i class="icon-base ti tabler-building"></i>
                    <span><?php echo e($pelatihan->dinas?->nama_dinas ?? __('Dinas Penyelenggara')); ?></span>
                  </div>

                  <div class="card-meta">
                    <i class="icon-base ti tabler-calendar"></i>
                    <span><?php echo e($dateRange); ?></span>
                  </div>

                  <div class="card-meta">
                    <i class="icon-base ti tabler-map-pin"></i>
                    <span><?php echo e($lokasiText); ?></span>
                  </div>

                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isKuotaUnlimited): ?>
                    <div class="quota-bar">
                      <div class="quota-label">
                        <span><?php echo e(__('Terisi')); ?></span>
                        <strong><?php echo e($quotaText); ?></strong>
                      </div>
                      <div class="progress">
                        <div class="progress-bar <?php echo e($barColor); ?>" role="progressbar" style="width: <?php echo e($percentage); ?>%" aria-valuenow="<?php echo e($percentage); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                ...
                <div class="card-footer-action">
                  ...
                  <a href="#beranda" class="btn-daftar-card">
                    <?php echo e(__('Daftar')); ?> <i class="icon-base ti tabler-arrow-right"></i>
                  </a>
                </div>
              </div>
            </div>
      ...
      <?php else: ?>
        <div class="pelatihan-empty-state reveal">
          ...
          <h5><?php echo e($pelatihan_empty_title); ?></h5>
          <p><?php echo e($pelatihan_empty_desc); ?></p>
        </div>
      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pelatihans->count() > 0): ?>
        <div class="text-center mt-5 reveal">
          <a href="<?php echo e(route('pelatihan.index')); ?>" class="btn btn-outline-light btn-lg px-5 py-3 fw-semibold" style="border-radius: 5px; border-width: 2px; font-family: 'Sora', sans-serif;">
    ...
    <div class="container py-4">
      ...
      <div class="text-center mb-5 pb-3 reveal">
        <span class="badge bg-warning bg-opacity-10 text-warning px-4 py-2 fw-semibold mb-3" style="font-size: 0.8rem; letter-spacing: 0.05em; border: 1px solid rgba(245, 158, 11, 0.15); border-radius: 5px;">
          <?php echo e($why_badge); ?> <?php echo e($institutionName); ?>

        </span>
        <h2 class="fw-bold mb-3 display-6" style="color: #0b0f19; font-family: 'Sora', sans-serif;"><?php echo e($why_title); ?></h2>
        <p class="text-muted fs-5 mx-auto" style="max-width: 580px;">
          <?php echo e($why_subtitle); ?>
          ...
          <div class="row g-3">
            <div class="col-sm-6">
              <div class="d-flex align-items-center gap-2">
                ...
                <span class="fw-semibold small text-dark">Sertifikat Resmi <?php echo e($institutionName); ?></span>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="d-flex align-items-center gap-2">
  ...
  <section id="faq" class="py-8 py-lg-10" style="background: #f1f5f9; color: #1e293b;">
    <div class="container py-4">
      ...
      <div class="text-center mb-5 pb-3 reveal">
        <span class="badge bg-primary bg-opacity-10 text-primary px-4 py-2 fw-semibold mb-3" style="font-size: 0.8rem; letter-spacing: 0.05em; border-radius: 5px;">
          <?php echo e(__('PERTANYAAN UMUM')); ?>

        </span>
        <h2 class="fw-bold mb-3 display-6" style="color: #0b0f19; font-family: 'Sora', sans-serif;"><?php echo e(__('Pertanyaan yang Sering Diajukan')); ?></h2>
        <p class="text-muted fs-5 mx-auto" style="max-width: 540px;">
          <?php echo e(__('Cari jawaban atas keraguan Anda mengenai pendaftaran dan metode pelatihan kami')); ?>
          ...
          <div class="accordion" id="accordionFaq">
              ...
              <div class="faq-accordion-item border-0">
                <h3 class="accordion-header" id="heading<?php echo e($index); ?>">
                  <button class="faq-accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#collapse<?php echo e($index); ?>" aria-expanded="false" aria-controls="collapse<?php echo e($index); ?>">
                ...
                <div id="collapse<?php echo e($index); ?>" class="accordion-collapse collapse"
                  aria-labelledby="heading<?php echo e($index); ?>" data-bs-parent="#accordionFaq">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
              <div class="text-center py-4">
                <p class="text-muted"><?php echo e(__('Belum ada FAQ.')); ?></p>
              </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          </div>
        </div>
      ...
      <div class="cta-mesh-container text-center text-white position-relative overflow-hidden reveal">
        ...
        <div class="position-relative" style="z-index: 5;">
          <span class="badge bg-white bg-opacity-10 text-warning px-4 py-2 fw-semibold mb-4" style="font-size: 0.8rem; letter-spacing: 0.05em; border: 1px solid rgba(255,255,255,0.15); border-radius: 5px;">
            🚀 <?php echo e($cta_badge); ?>

          </span>
          <h2 class="fw-bold text-white mb-3 display-5" style="font-family: 'Sora', sans-serif;"><?php echo e($cta_title); ?></h2>
          <p class="fs-5 mb-5 text-white-50 mx-auto" style="max-width: 580px;">
            <?php echo e($cta_subtitle); ?>
          ...
          <div class="d-flex gap-3 justify-content-center flex-wrap">
            <a href="#beranda" class="btn btn-warning btn-lg px-5 fw-semibold btn-glow py-3" style="font-family: 'Sora', sans-serif; border-radius: 5px;">
              <i class="icon-base ti tabler-user-plus me-2"></i><?php echo e($cta_button_text); ?>

            </a>
            <a href="<?php echo e(route('login')); ?>" class="btn btn-glow-outline btn-lg px-5 fw-semibold py-3 d-flex align-items-center gap-2" style="border-radius: 5px;">
              <i class="icon-base ti tabler-login fs-5"></i><?php echo e($cta_login_text); ?>
...
<?php echo $__env->make('layouts/publicLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/landing/beranda.blade.php ENDPATH**/ ?>