...
<div class="page-wrapper" style="position: relative;">
    ...
    <div class="card" style="position: relative;">
        ...
        <div class="card-head">
            <div class="step-top">
                <span class="step-chip"><?php echo $__env->yieldContent('step-chip', 'Setup'); ?></span>
                <span class="step-of">Langkah <strong><?php echo $__env->yieldContent('step-num', '1'); ?></strong> dari 3</span>
            </div>
            <div class="prog-track">
                <div class="prog-fill" style="width:<?php echo $__env->yieldContent('progress','33'); ?>%"></div>
            </div>
            <div class="head-title"><?php echo $__env->yieldContent('step-title'); ?></div>
            <div class="head-desc"><?php echo $__env->yieldContent('step-desc'); ?></div>
        </div>

        <form action="<?php echo $__env->yieldContent('form-action','#'); ?>" method="POST" id="installer-form" autocomplete="off" style="display: flex; flex-direction: column; overflow: hidden; flex: 1;">
            <?php echo csrf_field(); ?>
            <div class="card-body"><?php echo $__env->yieldContent('content'); ?></div>
            <div class="card-foot">
                <div class="foot-l"><?php echo $__env->yieldContent('foot-l'); ?></div>
                <div class="foot-r"><?php echo $__env->yieldContent('foot-r'); ?></div>
            </div>
        </form>
...
<?php /**PATH D:\Project\Pelatihanku\resources\views/installer/layout.blade.php ENDPATH**/ ?>