...
<?php $__env->startSection('title', 'Form Pendidikan'); ?>
...
<div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
  ...
  <div class="glass-card-dashboard" x-data="pendidikanForm()" x-cloak>
    <form id="formPendidikan" action="<?php echo e(route('dashboard.peserta.form-pendidikan.store')); ?>" method="POST">
      <?php echo csrf_field(); ?>
      ...
      <div class="tab-pane-step">
        ...
        <div class="field-group">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('pendidikan_terakhir', $fActive)): ?>
          <div>
            <label class="form-label form-label-custom" for="pendidikan_terakhir">
              <?php echo e($fLabels['pendidikan_terakhir'] ?? 'Pendidikan Terakhir'); ?>

              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('pendidikan_terakhir', $fRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </label>
            <select id="pendidikan_terakhir" name="pendidikan_terakhir" class="select2 form-select form-control form-control-custom" x-model="form.pendidikan_terakhir"
              ...
              <option value="" disabled><?php echo e($fPlaceholders['pendidikan_terakhir'] ?? 'PILIH PENDIDIKAN'); ?></option>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $pendidikanOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('tahun_lulus', $fActive)): ?>
          <div>
            <label class="form-label form-label-custom" for="tahun_lulus">
              <?php echo e($fLabels['tahun_lulus'] ?? 'Tahun Lulus'); ?>

              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('tahun_lulus', $fRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </label>
            <select id="tahun_lulus" name="tahun_lulus" class="select2 form-select form-control form-control-custom" x-model="form.tahun_lulus"
              ...
              <option value="" disabled><?php echo e($fPlaceholders['tahun_lulus'] ?? 'PILIH TAHUN'); ?></option>
        ...
        <div class="field-group mt-3">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('nama_institusi', $fActive)): ?>
          <div>
            <label class="form-label form-label-custom" for="nama_institusi">
              <?php echo e($fLabels['nama_institusi'] ?? 'Nama Institusi'); ?>

              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('nama_institusi', $fRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </label>
            <input type="text" id="nama_institusi" name="nama_institusi" class="form-control form-control-custom form-control-uppercase"
              x-model="form.nama_institusi" placeholder="<?php echo e($fPlaceholders['nama_institusi'] ?? 'NAMA SEKOLAH/UNIVERSITAS'); ?>"
          ...
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('jurusan', $fActive)): ?>
          <div>
            <label class="form-label form-label-custom" for="jurusan">
              <?php echo e($fLabels['jurusan'] ?? 'Jurusan'); ?>

              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('jurusan', $fRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </label>
            <input type="text" id="jurusan" name="jurusan" class="form-control form-control-custom form-control-uppercase"
              x-model="form.jurusan" placeholder="<?php echo e($fPlaceholders['jurusan'] ?? 'JURUSAN (JIKA ADA)'); ?>"
        ...
        <div class="field-group mt-3">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('status_pekerjaan', $fActive)): ?>
          <div>
            <label class="form-label form-label-custom" for="status_pekerjaan">
              <?php echo e($fLabels['status_pekerjaan'] ?? 'Status Pekerjaan'); ?>

              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('status_pekerjaan', $fRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </label>
            <select id="status_pekerjaan" name="status_pekerjaan" class="select2 form-select form-control form-control-custom" x-model="form.status_pekerjaan"
              ...
              <option value="" disabled><?php echo e($fPlaceholders['status_pekerjaan'] ?? 'PILIH STATUS'); ?></option>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $pekerjaanOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($value); ?>"><?php echo e($label); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </select>
          ...
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('nama_perusahaan', $fActive)): ?>
          <div x-show="form.status_pekerjaan === 'BEKERJA'">
            <label class="form-label form-label-custom" for="nama_perusahaan">
              <?php echo e($fLabels['nama_perusahaan'] ?? 'Nama Perusahaan'); ?>

              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('nama_perusahaan', $fRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </label>
            <input type="text" id="nama_perusahaan" name="nama_perusahaan" class="form-control form-control-custom form-control-uppercase"
              x-model="form.nama_perusahaan" placeholder="<?php echo e($fPlaceholders['nama_perusahaan'] ?? 'NAMA PERUSAHAAN / INSTANSI'); ?>"
      ...
      <div class="d-flex justify-content-between mt-4">
        <a href="<?php echo e(route('dashboard.peserta.form-alamat')); ?>" class="btn btn-glow-outline fw-semibold py-2 px-4" style="border-radius: 5px; font-size: 13px;">
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/dashboard/peserta/form-pendidikan.blade.php ENDPATH**/ ?>