  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
    ...
    <div class="glass-card-premium px-4 px-xl-5 py-4 mb-4">
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <a href="<?php echo e(route('admin.push-notifications.create')); ?>" class="btn btn-primary btn-action px-4 py-2">
          ...
          <tbody>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.04);">
                <td class="px-0"><?php echo e($notification->title); ?></td>
                <td><?php echo e($notification->target_type === 'all' ? 'Semua' : 'Filter'); ?></td>
                <td><?php echo e($notification->total_target); ?></td>
                <td>
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($notification->sent_at): ?>
                    <span class="badge-premium badge-premium-success">Sukses: <?php echo e($notification->sent_count); ?> | Gagal: <?php echo e($notification->failed_count); ?></span>
                  <?php else: ?>
                    <span class="badge-premium badge-premium-warning">Pending</span>
                  <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </td>
                <td><?php echo e($notification->sent_at?->format('d M Y H:i') ?? '-'); ?></td>
                <td class="text-end px-0">
                  <div class="d-flex gap-2 justify-content-end">
                      <a href="<?php echo e(route('admin.push-notifications.show', $notification)); ?>" class="btn btn-outline-info btn-action" style="border-color: rgba(96,165,250,0.3); color: #93c5fd;">Detail</a>
                      <form action="<?php echo e(route('admin.push-notifications.destroy', $notification)); ?>" method="POST" class="delete-push-notification-form d-inline">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/admin/push-notifications/index.blade.php ENDPATH**/ ?>