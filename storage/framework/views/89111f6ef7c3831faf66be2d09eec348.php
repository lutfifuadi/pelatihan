...
<?php $__env->startSection('title', 'Broadcast WhatsApp'); ?>
  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
      <div class="alert alert-success alert-dismissible border-0 mb-4" role="alert" style="background: linear-gradient(135deg, #10b981, #059669); color: white; border-radius: 5px;">
        <div class="d-flex align-items-center"><i class="icon-base ti tabler-check-circle fs-5 me-2"></i><span><?php echo e(session('success')); ?></span></div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
      <div class="alert alert-danger alert-dismissible border-0 mb-4" role="alert" style="background: linear-gradient(135deg, #ef4444, #b91c1c); color: white; border-radius: 5px;">
        <div class="d-flex align-items-center"><i class="icon-base ti tabler-alert-circle fs-5 me-2"></i><span><?php echo e(session('error')); ?></span></div>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="alert" aria-label="Close"></button>
      </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="row g-4">
      <div class="col-lg-8">
        <form id="broadcastForm" action="<?php echo e(route('admin.notifications.broadcast.send')); ?>" method="POST" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          ...
          <div class="glass-card-premium px-4 px-xl-5 py-4 mb-4">
            ...
            <div class="row g-3 mb-4">
              <div class="col-md-6">
                <div class="target-card <?php if(old('target') == 'all_peserta'): ?> active <?php endif; ?>" onclick="selectTarget('all_peserta')">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="target" id="target_all_peserta" value="all_peserta"
                      <?php echo e(old('target') == 'all_peserta' ? 'checked' : ''); ?>
              ...
              <div class="col-md-6">
                <div class="target-card <?php if(old('target') == 'by_pelatihan'): ?> active <?php endif; ?>" onclick="selectTarget('by_pelatihan')">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="target" id="target_by_pelatihan" value="by_pelatihan"
                      <?php echo e(old('target') == 'by_pelatihan' ? 'checked' : ''); ?>
              ...
              <div class="col-md-6">
                <div class="target-card <?php if(old('target') == 'all_koordinator'): ?> active <?php endif; ?>" onclick="selectTarget('all_koordinator')">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="target" id="target_all_koordinator" value="all_koordinator"
                      <?php echo e(old('target') == 'all_koordinator' ? 'checked' : ''); ?>
              ...
              <div class="col-md-6">
                <div class="target-card <?php if(old('target') == 'by_enrollment_status'): ?> active <?php endif; ?>" onclick="selectTarget('by_enrollment_status')">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="target" id="target_by_enrollment_status" value="by_enrollment_status"
                      <?php echo e(old('target') == 'by_enrollment_status' ? 'checked' : ''); ?>
              ...
              <div class="col-md-6">
                <div class="target-card <?php if(old('target') == 'custom'): ?> active <?php endif; ?>" onclick="selectTarget('custom')">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="target" id="target_custom" value="custom"
                      <?php echo e(old('target') == 'custom' ? 'checked' : ''); ?>
            ...
            <div id="pelatihanField" class="mb-4" style="display: <?php echo e(old('target') == 'by_pelatihan' ? 'block' : 'none'); ?>;">
              ...
              <select class="select2 form-select" id="pelatihan_id" name="pelatihan_id" data-placeholder="-- Pilih Pelatihan --">
                <option value=""></option>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $pelatihans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($pel->id); ?>" <?php echo e(old('pelatihan_id') == $pel->id ? 'selected' : ''); ?>>
                    <?php echo e($pel->nama); ?> (Batch <?php echo e($pel->batch); ?>)
                  </option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
              </select>
            </div>

            <div id="enrollmentStatusField" class="mb-4" style="display: <?php echo e(old('target') == 'by_enrollment_status' ? 'block' : 'none'); ?>;">
              ...
              <select class="select2 form-select" id="enrollment_status" name="enrollment_status" data-placeholder="-- Pilih Status --">
                <option value=""></option>
                <option value="pending" <?php echo e(old('enrollment_status') == 'pending' ? 'selected' : ''); ?>>⏳ Pending</option>
                <option value="approved" <?php echo e(old('enrollment_status') == 'approved' ? 'selected' : ''); ?>>✅ Approved</option>
                <option value="waiting_wa_confirmation" <?php echo e(old('enrollment_status') == 'waiting_wa_confirmation' ? 'selected' : ''); ?>>⏳ Menunggu Chat WA</option>
                <option value="waiting_newbimma_check" <?php echo e(old('enrollment_status') == 'waiting_newbimma_check' ? 'selected' : ''); ?>>🔄 Cek Newbimma</option>
                <option value="confirmed" <?php echo e(old('enrollment_status') == 'confirmed' ? 'selected' : ''); ?>>✅ Terkonfirmasi</option>
                <option value="rejected" <?php echo e(old('enrollment_status') == 'rejected' ? 'selected' : ''); ?>>❌ Ditolak</option>
                <option value="waitlist" <?php echo e(old('enrollment_status') == 'waitlist' ? 'selected' : ''); ?>>🟡 Cadangan</option>
              </select>
            </div>

            <div id="csvField" class="mb-4" style="display: <?php echo e(old('target') == 'custom' ? 'block' : 'none'); ?>;">
...
unset($__errorArgs, $__bag); ?>"
              ...
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['csv_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
            ...
            <div class="mb-4">
              ...
              <select class="select2 form-select" id="template_id" name="template_id" data-placeholder="-- Pilih Template (Opsional) --">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($tpl->id); ?>" data-body="<?php echo e($tpl->body); ?>" <?php echo e(old('template_id') == $tpl->id ? 'selected' : ''); ?>>
                    <?php echo e($tpl->name); ?>
...
unset($__errorArgs, $__bag); ?>"
                ...
                placeholder="Tulis pesan broadcast..."><?php echo e(old('custom_message')); ?></textarea>
              <small class="text-body-premium mt-1 d-block" style="font-size: 0.75rem;">
                Gunakan <code>{nama}</code>, <code>{pelatihan}</code>, <code>{tanggal}</code> untuk data dinamis
              </small>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['custom_message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      ...
      <div class="col-lg-4">
        ...
        <div class="glass-card-premium px-4 py-4 mb-4">
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentBroadcasts->isEmpty()): ?>
          ...
          <?php else: ?>
            <div class="d-flex flex-column gap-3">
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $recentBroadcasts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div style="border-bottom: 1px solid rgba(255,255,255,0.04); padding-bottom: 8px;">
                  <div class="d-flex justify-content-between align-items-center">
                    <small class="text-white fw-semibold"><?php echo e($notif->user->name ?? 'Unknown'); ?></small>
                    <small class="text-body-premium" style="font-size: 11px;"><?php echo e($notif->created_at->diffForHumans()); ?></small>
                  </div>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  async function updateRecipientCount() {
    ...
    const countUrl = `<?php echo e(route('admin.notifications.broadcast.count')); ?>?${params.toString()}`;
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/admin/notifications/broadcast.blade.php ENDPATH**/ ?>