...
<div id="auth-page-wrapper">
  ...
  <div class="glass-card-premium">
    ...
    <div class="d-flex justify-content-center mb-4">
      <a href="<?php echo e(url('/')); ?>" class="d-flex align-items-center gap-2 text-decoration-none">
...
<?php endif; ?>
    ...
    <form id="formAuthentication" action="<?php echo e(route('login')); ?>" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control form-control-custom <?php $__errorArgs = ['nik'];
...
unset($__errorArgs, $__bag); ?>" 
          ...
          autofocus value="<?php echo e(old('nik')); ?>" required />
...
$message = $__bag->first($__errorArgs[0]); ?>
        <div class="invalid-feedback small mt-1 text-danger"><?php echo e($message); ?></div>
        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
unset($__errorArgs, $__bag); ?>">
          <input type="password" id="login-password" class="form-control form-control-custom <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      ...
      <div class="mb-4">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <a href="<?php echo e(route('password.request')); ?>" class="small fw-semibold text-warning text-decoration-none hover-white">
            Lupa Password?
          </a>
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    ...
    <p class="text-center mb-0">
      ...
      <a href="<?php echo e(route('register')); ?>" class="small fw-semibold text-warning text-decoration-none hover-white">
        Daftar di sini
      </a>
      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/blankLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/auth/login.blade.php ENDPATH**/ ?>