...
<?php $__env->startSection('title', 'Log Pengiriman Notifikasi'); ?>
        ...
        <div class="filter-section">
          <div>
            ...
            <select name="channel" class="form-select" style="min-width: 130px;">
              ...
              <option value="whatsapp" <?php if(request('channel') == 'whatsapp'): echo 'selected'; endif; ?>>WhatsApp</option>
              <option value="email" <?php if(request('channel') == 'email'): echo 'selected'; endif; ?>>Email</option>
              <option value="in_app" <?php if(request('channel') == 'in_app'): echo 'selected'; endif; ?>>In-App</option>
            </select>
          </div>
          <div>
          ...
          <div>
            ...
            <input type="date" name="date_from" class="form-control" value="<?php echo e(request('date_from')); ?>" style="min-width: 140px;">
          </div>
          <div>
            <label class="form-label small mb-1">Sampai Tanggal</label>
            <input type="date" name="date_to" class="form-control" value="<?php echo e(request('date_to')); ?>" style="min-width: 140px;">
          </div>
          <div>
            <label class="form-label small mb-1">Cari User</label>
            <input type="text" name="search" class="form-control" value="<?php echo e(request('search')); ?>" placeholder="Nama user..." style="min-width: 160px;">
          </div>
          <div>
            ...
            <a href="<?php echo e(route('admin.notifications.index')); ?>" class="btn btn-secondary-custom px-3 py-2" style="font-size: 13px;">
            ...
            <tbody>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.04);">
                  <td class="px-0 py-3 text-body-premium">#<?php echo e($notification->id); ?></td>
                  <td class="py-3">
                    <div class="fw-semibold text-white"><?php echo e($notification->user->name ?? 'System'); ?></div>
                    <small class="text-body-premium"><?php echo e($notification->recipient); ?></small>
                  </td>
                  <td class="py-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($notification->channel == 'whatsapp'): ?>
                  ...
                  <td class="py-3 text-body-premium">
                    <?php echo e($notification->template->name ?? 'Custom'); ?>
                  ...
                  <td class="py-3">
                    ...
                    ?>
                    <span class="badge-premium <?php echo e($statusColors[$notification->status] ?? 'badge-premium-warning'); ?>">
                      <?php echo e($statusLabels[$notification->status] ?? ucfirst($notification->status)); ?>
                  ...
                  <td class="text-end px-0 py-3">
                    <div class="d-inline-flex gap-2">
                      <button type="button" class="btn btn-info btn-sm d-flex align-items-center justify-content-center"
                        ...
                        onclick="showDetail(<?php echo e($notification->id); ?>)" title="Detail">
                      ...
                      <button type="button" class="btn btn-danger btn-sm d-flex align-items-center justify-content-center"
                        ...
                        onclick="showDeleteModal(<?php echo e($notification->id); ?>, '<?php echo e($notification->user->name ?? 'System'); ?>', '<?php echo e($notification->channel); ?>', '<?php echo e(addslashes($notification->title)); ?>', '<?php echo e($notification->status); ?>')">
                        <i class="icon-base ti tabler-trash fs-5"></i>
                      </button>
                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($notification->status == 'failed'): ?>
                        <form action="<?php echo e(route('admin.notifications.resend', $notification)); ?>" method="POST" class="d-inline">
                          <?php echo csrf_field(); ?>
...
function countNotifications() {
  ...
  fetch('<?php echo e(route('admin.notifications.count-filtered')); ?>?' + params.toString())
    .then(res => res.json())
    .then(data => {
...
function destroyAll() {
  ...
  form.method = 'POST';
  form.action = '<?php echo e(route('admin.notifications.destroy-all')); ?>';
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/admin/notifications/index.blade.php ENDPATH**/ ?>