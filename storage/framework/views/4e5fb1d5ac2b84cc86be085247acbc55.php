...
<?php $__env->startSection('title', 'Pendaftaran Pelatihan'); ?>
  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
      <div class="alert alert-success alert-dismissible border-0 mb-4" role="alert" style="background: linear-gradient(135deg, #10b981, #059669); color: white; border-radius: 5px;">
        <i class="icon-base ti tabler-check-circle fs-5 me-2"></i><?php echo e(session('success')); ?>
      ...
      <div class="col-md col-6">
        <div class="glass-card-premium px-2 py-2">
          <div class="d-flex align-items-center justify-content-between gap-2">
            ...
            <div class="text-end">
              <h5 class="fw-bold text-white mb-0" id="stat-pending" style="font-size: 1.5rem; line-height: 1.2;"><?php echo e($counts['pending']); ?></h5>
      ...
      <div class="col-md col-6">
        <div class="glass-card-premium px-2 py-2">
          <div class="d-flex align-items-center justify-content-between gap-2">
            ...
            <div class="text-end">
              <h5 class="fw-bold text-white mb-0" id="stat-approved" style="font-size: 1.5rem; line-height: 1.2;"><?php echo e($counts['approved']); ?></h5>
      ...
      <div class="col-md col-6">
        <div class="glass-card-premium px-2 py-2">
          <div class="d-flex align-items-center justify-content-between gap-2">
            ...
            <div class="text-end">
              <h5 class="fw-bold text-white mb-0" id="stat-waiting-wa" style="font-size: 1.5rem; line-height: 1.2;"><?php echo e($counts['waiting_wa'] ?? 0); ?></h5>
      ...
      <div class="col-md col-6">
        <div class="glass-card-premium px-2 py-2">
          <div class="d-flex align-items-center justify-content-between gap-2">
            ...
            <div class="text-end">
              <h5 class="fw-bold text-white mb-0" id="stat-waiting-newbimma" style="font-size: 1.5rem; line-height: 1.2;"><?php echo e($counts['waiting_newbimma'] ?? 0); ?></h5>
      ...
      <div class="col-md col-6">
        <div class="glass-card-premium px-2 py-2">
          <div class="d-flex align-items-center justify-content-between gap-2">
            ...
            <div class="text-end">
              <h5 class="fw-bold text-white mb-0" id="stat-confirmed" style="font-size: 1.5rem; line-height: 1.2;"><?php echo e($counts['confirmed'] ?? 0); ?></h5>
      ...
      <div class="col-md col-6">
        <div class="glass-card-premium px-2 py-2">
          <div class="d-flex align-items-center justify-content-between gap-2">
            ...
            <div class="text-end">
              <h5 class="fw-bold text-white mb-0" id="stat-rejected" style="font-size: 1.5rem; line-height: 1.2;"><?php echo e($counts['rejected']); ?></h5>
      ...
      <div class="col-md col-6">
        <div class="glass-card-premium px-2 py-2">
          <div class="d-flex align-items-center justify-content-between gap-2">
            ...
            <div class="text-end">
              <h5 class="fw-bold text-white mb-0" id="stat-waitlist" style="font-size: 1.5rem; line-height: 1.2;"><?php echo e($counts['waitlist']); ?></h5>
          ...
          <div class="col-12">
            <div class="d-flex gap-2">
              <div class="position-relative flex-grow-1">
                ...
                <input type="text" id="search-input" class="form-control" placeholder="Cari nama peserta..." value="<?php echo e($search ?? ''); ?>" style="padding-left: 2.5rem !important;">
              </div>
              ...
              <a href="<?php echo e(route('admin.enrollments.index')); ?>" id="reset-btn" class="btn btn-secondary-custom px-3 py-2 <?php echo e(($search ?? '') ? '' : 'd-none'); ?>" title="Reset pencarian">
      ...
      <div class="row g-3 align-items-end">
        <div class="col-md-6">
          ...
          <select id="filter-pelatihan" class="form-select">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $pelatihans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($p->id); ?>" <?php echo e(request('pelatihan_id') == $p->id ? 'selected' : ''); ?>>
                <?php echo e($p->nama); ?> (<?php echo e($p->batch); ?>)
              </option>
        ...
        <div class="col-md-3">
          ...
          <select id="filter-status" class="form-select">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $filterStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="glass-card-premium px-4 py-3 mb-4 <?php echo e(request('pelatihan_id') ? '' : 'd-none'); ?>" id="action-buttons-container">
      <div class="row align-items-center g-2">
        <div class="col-12">
          <div class="d-flex flex-wrap gap-2">
            
            <button type="button" id="btn-approve-all" class="btn btn-success btn-action px-4"
              data-url="<?php echo e(request('pelatihan_id') ? route('admin.enrollments.approve-all', ['pelatihan' => request('pelatihan_id')]) : ''); ?>"
              data-pending="<?php echo e($counts['pending']); ?>">
              <i class="icon-base ti tabler-check me-1"></i>
              Approve All Pending <span class="badge bg-white text-dark ms-1"><?php echo e($counts['pending']); ?></span>
            </button>

            
            <button type="button" id="btn-reject-all" class="btn btn-danger btn-action px-4"
              data-url="<?php echo e(request('pelatihan_id') ? route('admin.enrollments.reject-all', ['pelatihan' => request('pelatihan_id')]) : ''); ?>"
              data-pending="<?php echo e($counts['pending']); ?>">
              <i class="icon-base ti tabler-x me-1"></i>
              Reject All Pending <span class="badge bg-white text-dark ms-1"><?php echo e($counts['pending']); ?></span>
            </button>
          </div>
    ...
    <div class="glass-card-premium px-4 py-3 mb-4">
      <div class="row align-items-center">
        <div class="col-12">
        <form action="<?php echo e(route('admin.enrollments.generate-all-verification-codes')); ?>" method="POST" class="d-inline" id="form-generate-all-codes">
          <?php echo csrf_field(); ?>
    ...
    <div class="glass-card-premium px-4 py-3 mb-4">
      <div class="d-flex justify-content-end align-items-center gap-2">
        <a href="<?php echo e(request('pelatihan_id') ? route('admin.exports.enrollments.pdf', ['pelatihan' => request('pelatihan_id')]) : route('admin.exports.enrollments.pdf')); ?>" class="btn btn-outline-info btn-action" style="border-color: rgba(96,165,250,0.3); color: #93c5fd;">
          <i class="icon-base ti tabler-file-export me-1"></i> 📄 Export PDF
        </a>
        <a href="<?php echo e(request('pelatihan_id') ? route('admin.exports.enrollments.excel', ['pelatihan' => request('pelatihan_id')]) : route('admin.exports.enrollments.excel')); ?>" class="btn btn-outline-success btn-action" style="border-color: rgba(16,185,129,0.3); color: #34d399;">
      ...
      <div class="table-responsive">
        <table class="table table-borderless text-white align-middle">
          ...
          <tbody id="table-content">
            <?php echo $__env->make('content.admin.enrollments._table_rows', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          </tbody>
        </table>
      </div>
      <div id="table-pagination">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($enrollments->hasPages()): ?>
...
(function() {
    ...
    filterResetBtn.addEventListener('click', function() {
      ...
      window.location.href = '<?php echo e(route('admin.enrollments.index')); ?>';
    });
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/admin/enrollments/index.blade.php ENDPATH**/ ?>