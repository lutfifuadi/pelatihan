...
<?php $__env->startSection('title', 'Kelola Kelurahan'); ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <!-- Content Wrapper -->
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;" id="kelurahan-page">
      ...
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div class="d-flex align-items-center gap-3">
          <div class="stat-icon-box stat-icon-primary">
            <i class="icon-base ti tabler-building fs-4"></i>
          </div>
          <div>
            <h4 class="fw-bold text-white mb-0">Kelola Kelurahan</h4>
            <p class="text-body-premium mb-0 mt-1" style="font-size: 0.95rem;">
              Daftar dan konfigurasi data kelurahan
            </p>
          </div>
        </div>
        <a href="<?php echo e(route('admin.kelurahan.create')); ?>" class="btn btn-glow-premium px-4 py-2 d-flex align-items-center gap-2">
          <i class="icon-base ti tabler-plus"></i> Tambah Kelurahan
        </a>
      </div>
    </div>
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="position-relative flex-grow-1">
            ...
            <input type="text" id="search-input"
              class="form-control" placeholder="Cari nama kelurahan..." value="<?php echo e($search ?? ''); ?>" style="padding-left: 2.5rem !important; border-radius: 5px;">
          </div>
          <a href="<?php echo e(route('admin.kelurahan.index')); ?>" id="reset-btn" class="btn btn-secondary-custom px-3 py-2 <?php echo e(request()->has('search') && request('search') != '' ? '' : 'd-none'); ?>" style="white-space: nowrap;">
          ...
          <table class="table table-borderless text-white align-middle">
            <thead>
              <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.08);">
                ...
                <th class="text-body-premium small fw-semibold">Nama Koordinator</th>
                <th class="text-body-premium small fw-semibold">Nomor Kontak</th>
                <th class="text-body-premium small fw-semibold text-end px-0" style="width: 120px;">Aksi</th>
              </tr>
            </thead>
            <tbody id="table-content">
              <?php echo $__env->make('content.admin.kelurahan._table_rows', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </tbody>
          </table>
        </div>
        <!-- Pagination -->
        <div id="table-pagination">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kelurahans->hasPages()): ?>
            <div class="mt-4 pt-3" style="border-top: 1px solid rgba(255, 255, 255, 0.05);">
              <?php echo e($kelurahans->links()); ?>
...
<script>
  (function() {
    ...
    async function fetchData() {
      ...
      try {
        const res = await fetch(`/admin/kelurahan?${params.toString()}`, {
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/admin/kelurahan/index.blade.php ENDPATH**/ ?>