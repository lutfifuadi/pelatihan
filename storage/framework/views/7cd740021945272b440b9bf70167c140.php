...
<?php $__env->startSection('title', 'Kelola Kecamatan'); ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <!-- Content Wrapper -->
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;" id="kecamatan-page">
      ...
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div class="d-flex align-items-center gap-3">
          <div class="stat-icon-box stat-icon-primary">
            <i class="icon-base ti tabler-map-pin fs-4"></i>
          </div>
          <div>
            <h4 class="fw-bold text-white mb-0">Kelola Kecamatan</h4>
            <p class="text-body-premium mb-0 mt-1" style="font-size: 0.95rem;">
              Daftar dan konfigurasi data kecamatan
            </p>
          </div>
        </div>
        <a href="<?php echo e(route('admin.kecamatan.create')); ?>" class="btn btn-glow-premium px-4 py-2 d-flex align-items-center gap-2">
          <i class="icon-base ti tabler-plus"></i> Tambah Kecamatan
        </a>
      </div>
    </div>
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="position-relative flex-grow-1">
            ...
            <input type="text" id="search-input"
              class="form-control" placeholder="Cari nama kecamatan..." value="<?php echo e($search ?? ''); ?>" style="padding-left: 2.5rem !important; border-radius: 5px;">
          </div>
          <a href="<?php echo e(route('admin.kecamatan.index')); ?>" id="reset-btn" class="btn btn-secondary-custom px-3 py-2 <?php echo e(request()->has('search') && request('search') != '' ? '' : 'd-none'); ?>" style="white-space: nowrap;">
        ...
        <div class="table-responsive">
          <table class="table table-borderless text-white align-middle">
            ...
            <tbody id="table-content">
              <?php echo $__env->make('content.admin.kecamatan._table_content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </tbody>
          </table>
        </div>
        <!-- Pagination -->
        <div id="table-pagination">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kecamatans->hasPages()): ?>
...
<script>
  (function() {
    ...
    async function fetchData() {
      ...
      try {
        const res = await fetch(`/admin/kecamatan?${params.toString()}`, {
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/admin/kecamatan/index.blade.php ENDPATH**/ ?>