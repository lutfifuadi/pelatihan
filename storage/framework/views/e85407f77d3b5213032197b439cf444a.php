...
<?php $__env->startSection('title', 'Kelola Dinas'); ?>
  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
      ...
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div class="d-flex align-items-center gap-3">
          <div class="stat-icon-box stat-icon-primary">
            <i class="icon-base ti tabler-building-community fs-4"></i>
          </div>
          <div>
            <h4 class="fw-bold text-white mb-0">Kelola Dinas</h4>
            <p class="text-body-premium mb-0 mt-1" style="font-size: 0.95rem;">
              Daftar dan konfigurasi data dinas/instansi
            </p>
          </div>
        </div>
        <a href="<?php echo e(route('admin.dinas.create')); ?>" class="btn btn-glow-premium px-4 py-2 d-flex align-items-center gap-2">
          <i class="icon-base ti tabler-plus"></i> Tambah Dinas
        </a>
      </div>
    </div>
    ...
    <div class="col-12">
      <div class="glass-card-premium px-4 py-4">
          ...
          <table class="table table-borderless text-white align-middle">
            <thead>
              <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.08);">
                ...
                <th class="text-body-premium small fw-semibold">Nama Dinas</th>
                <th class="text-body-premium small fw-semibold">Singkatan</th>
            ...
            <tbody>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $dinas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.04);">
                  <td class="px-0 py-3 text-body-premium"><?php echo e($dinas->firstItem() + $index); ?></td>
                  <td class="py-3 text-white fw-semibold"><?php echo e($d->nama_dinas); ?></td>
                  <td class="py-3 text-body-premium"><?php echo e($d->singkatan ?? '-'); ?></td>
                  <td class="py-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($d->is_active): ?>
                  ...
                  <td class="text-end px-0 py-3">
                    <div class="d-inline-flex gap-2">
                      <a href="<?php echo e(route('admin.dinas.edit', $d)); ?>" class="btn btn-warning btn-sm d-flex align-items-center justify-content-center" style="border-radius: 5px; width: 32px; height: 32px; padding: 0;">
                        <i class="icon-base ti tabler-edit fs-5 text-dark"></i>
                      </a>
                      <form action="<?php echo e(route('admin.dinas.destroy', $d)); ?>" method="POST" class="d-inline"
                        onsubmit="return confirm('Yakin ingin menghapus dinas <?php echo e($d->nama_dinas); ?>?')">
                        <?php echo csrf_field(); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dinas->hasPages()): ?>
          <div class="mt-4 pt-3" style="border-top: 1px solid rgba(255, 255, 255, 0.05);">
            <?php echo e($dinas->links()); ?>
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/admin/dinas/index.blade.php ENDPATH**/ ?>