        ...
        <div class="d-flex align-items-center gap-3">
          ...
          <div>
            ...
            <p class="text-body-premium mb-0 mt-1" style="font-size: 0.95rem;">
              Informasi lengkap peserta <?php echo e($peserta->name); ?>

            </p>
          </div>
        </div>
        <a href="<?php echo e(route('admin.peserta.index')); ?>" class="btn btn-secondary-custom px-4 py-2 d-flex align-items-center gap-2">
        ...
        <div class="row g-4">
            ...
            <div class="glass-card-premium px-4 py-4">
              ...
              <div class="row g-3">
                <div class="col-md-4">
                  ...
                  <div class="detail-value"><?php echo e($peserta->name); ?></div>
                </div>
                <div class="col-md-4">
                  <div class="detail-label">NIK</div>
                  <div class="detail-value"><?php echo e($peserta->nik ?? '-'); ?></div>
                </div>
                <div class="col-md-4">
                  <div class="detail-label">WhatsApp</div>
                  <div class="detail-value"><?php echo e($peserta->whatsapp ?? '-'); ?></div>
                </div>
                <div class="col-md-4">
                  <div class="detail-label">Email</div>
                  <div class="detail-value"><?php echo e($peserta->email ?? '-'); ?></div>
                </div>
                <div class="col-md-4">
                  <div class="detail-label">Jenis Kelamin</div>
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->jenis_kelamin ?? '-'); ?></div>
                </div>
                <div class="col-md-4">
                  <div class="detail-label">Tempat, Tanggal Lahir</div>
                  <div class="detail-value">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($peserta->pesertaProfile && $peserta->pesertaProfile->tempat_lahir): ?>
                      <?php echo e($peserta->pesertaProfile->tempat_lahir); ?>,
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($peserta->pesertaProfile && $peserta->pesertaProfile->tanggal_lahir): ?>
                      <?php echo e($peserta->pesertaProfile->tanggal_lahir); ?>

                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($peserta->pesertaProfile && $peserta->pesertaProfile->bulan_lahir): ?>
                      /<?php echo e($peserta->pesertaProfile->bulan_lahir); ?>

                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($peserta->pesertaProfile && $peserta->pesertaProfile->tahun_lahir): ?>
                      /<?php echo e($peserta->pesertaProfile->tahun_lahir); ?>

                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$peserta->pesertaProfile || (!$peserta->pesertaProfile->tempat_lahir && !$peserta->pesertaProfile->tanggal_lahir)): ?>
                      -
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                  </div>
                </div>
                <div class="col-md-4">
                  ...
                  <div class="detail-value">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($medsos && is_array($medsos)): ?>
                      <div class="d-flex flex-wrap gap-2">
                        <?php $hasMedsos = false; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $medsos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item['url'])): ?>
                            <?php $hasMedsos = true; ?>
                            <a href="<?php echo e($item['url']); ?>" target="_blank" class="badge bg-label-primary d-inline-flex align-items-center gap-1" style="text-decoration: none; font-size: 0.75rem; padding: 6px 12px;">
                              <?php
                              ...
                              ?>
                              <i class="icon-base ti <?php echo e($iconClass); ?> fs-6"></i>
                              <?php echo e($item['platform'] ?? 'Medsos'); ?>

                            </a>
                          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$hasMedsos): ?>
                          -
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                      </div>
                    <?php elseif($medsos && is_string($medsos)): ?>
                      <?php echo e($medsos); ?>
            ...
            <div class="glass-card-premium px-4 py-4">
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->alamat_ktp ?? '-'); ?></div>
                </div>
                <div class="col-md-2">
                  <div class="detail-label">RT</div>
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->rt ?? '-'); ?></div>
                </div>
                <div class="col-md-2">
                  <div class="detail-label">RW</div>
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->rw ?? '-'); ?></div>
                </div>
                <div class="col-md-2">
                  <div class="detail-label">Kodepos</div>
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->kodepos ?? '-'); ?></div>
                </div>
                <div class="col-md-3">
                  <div class="detail-label">Kelurahan</div>
                  <div class="detail-value"><?php echo e($peserta->kelurahan->name ?? $peserta->pesertaProfile->kelurahan ?? '-'); ?></div>
                </div>
                <div class="col-md-3">
                  <div class="detail-label">Kecamatan</div>
                  <div class="detail-value"><?php echo e($peserta->kecamatan->name ?? $peserta->pesertaProfile->kecamatan ?? '-'); ?></div>
                </div>
                <div class="col-md-3">
                  <div class="detail-label">Kota</div>
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->kota ?? '-'); ?></div>
                </div>
                <div class="col-md-3">
                  <div class="detail-label">Provinsi</div>
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->provinsi ?? '-'); ?></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="glass-card-premium px-4 py-4">
              ...
              <div class="row g-3">
                <div class="col-md-3">
                  ...
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->pendidikan_terakhir ?? '-'); ?></div>
                </div>
                <div class="col-md-3">
                  <div class="detail-label">Nama Institusi</div>
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->nama_institusi ?? '-'); ?></div>
                </div>
                <div class="col-md-3">
                  <div class="detail-label">Jurusan</div>
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->jurusan ?? '-'); ?></div>
                </div>
                <div class="col-md-3">
                  <div class="detail-label">Tahun Lulus</div>
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->tahun_lulus ?? '-'); ?></div>
                </div>
                <div class="col-md-4">
                  <div class="detail-label">Status Pekerjaan</div>
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->status_pekerjaan ?? '-'); ?></div>
                </div>
                <div class="col-md-4">
                  <div class="detail-label">Nama Perusahaan</div>
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->nama_perusahaan ?? '-'); ?></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="glass-card-premium px-4 py-4">
              ...
              <div class="row g-3">
                <div class="col-md-4">
                  ...
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->pelatihan->nama ?? '-'); ?></div>
                </div>
                <div class="col-md-4">
                  <div class="detail-label">Batch Pelatihan</div>
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->batch_pelatihan ?? '-'); ?></div>
                </div>
                <div class="col-md-4">
                  <div class="detail-label">Dinas Penyelenggara</div>
                  <div class="detail-value"><?php echo e($peserta->pesertaProfile->pelatihan->dinas->nama_dinas ?? '-'); ?></div>
                </div>
                <div class="col-12">
                  <div class="detail-label">Deskripsi Pelatihan</div>
                  <div class="detail-value">
                    <?php echo e(strip_tags($peserta->pesertaProfile->pelatihan->deskripsi ?? '-')); ?>
          ...
          <div class="col-12">
            <div class="glass-card-premium px-4 py-4">
              ...
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($jawaban)): ?>
                <div class="row g-3">
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $jawaban; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                      $label = $fieldLabels[$key] ?? ucwords(str_replace('_', ' ', $key));
                    ?>
                    <div class="col-12">
                      <div class="detail-label" style="text-transform: none; letter-spacing: normal; font-size: 0.85rem; color: rgba(255, 255, 255, 0.45);"><?php echo e($label); ?></div>
                      <div class="detail-value fw-bold text-white mt-1" style="white-space: pre-wrap; font-size: 0.95rem;"><?php echo e(!empty($value) ? $value : '-'); ?></div>
                    </div>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
              <?php else: ?>
            ...
            <div class="glass-card-premium px-4 py-4">
              ...
              <div class="row g-3">
                <div class="col-md-3">
                  ...
                  <div class="detail-value"><?php echo e($peserta->created_at->format('d/m/Y H:i')); ?></div>
                </div>
                <div class="col-md-3">
                  <div class="detail-label">Status</div>
                  <div class="detail-value">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($peserta->is_active): ?>
      ...
      <div class="col-lg-4 col-md-5">
        <div class="glass-card-premium px-4 py-4">
          ...
          <div class="mb-4">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step6Done): ?>
          ...
          <div class="timeline-premium">
            ...
            <div class="timeline-item-premium">
              <div class="timeline-badge-premium <?php echo e($step1Done ? 'completed' : 'pending'); ?>">
                <i class="icon-base ti tabler-<?php echo e($step1Done ? 'check' : 'circle'); ?>"></i>
              </div>
              <div class="ps-2">
                ...
                <p class="text-body-premium mb-0 small" style="font-size: 0.75rem;">
                  <?php echo e($step1Done ? 'Selesai diisi' : 'Belum selesai'); ?>
            ...
            <div class="timeline-item-premium">
              <div class="timeline-badge-premium <?php echo e($step2Done ? 'completed' : 'pending'); ?>">
                <i class="icon-base ti tabler-<?php echo e($step2Done ? 'check' : 'circle'); ?>"></i>
              </div>
              <div class="ps-2">
                <h6 class="mb-1 text-white" style="font-size: 0.95rem;">Tahap 2: Alamat &amp; Kontak</h6>
                <p class="text-body-premium mb-0 small" style="font-size: 0.75rem;">
                  <?php echo e($step2Done ? 'Selesai diisi' : 'Belum selesai'); ?>
            ...
            <div class="timeline-item-premium">
              <div class="timeline-badge-premium <?php echo e($step3Done ? 'completed' : 'pending'); ?>">
                <i class="icon-base ti tabler-<?php echo e($step3Done ? 'check' : 'circle'); ?>"></i>
              </div>
              <div class="ps-2">
                <h6 class="mb-1 text-white" style="font-size: 0.95rem;">Tahap 3: Riwayat Pendidikan</h6>
                <p class="text-body-premium mb-0 small" style="font-size: 0.75rem;">
                  <?php echo e($step3Done ? 'Selesai diisi' : 'Belum selesai'); ?>
            ...
            <div class="timeline-item-premium">
              <div class="timeline-badge-premium <?php echo e($step4Done ? 'completed' : 'pending'); ?>">
                <i class="icon-base ti tabler-<?php echo e($step4Done ? 'check' : 'circle'); ?>"></i>
              </div>
              <div class="ps-2">
                <h6 class="mb-1 text-white" style="font-size: 0.95rem;">Tahap 4: Pilihan Pelatihan</h6>
                <p class="text-body-premium mb-0 small" style="font-size: 0.75rem;">
                  <?php echo e($step4Done ? 'Selesai diisi' : 'Belum selesai'); ?>
            ...
            <div class="timeline-item-premium">
              <div class="timeline-badge-premium <?php echo e($step5Done ? 'completed' : 'pending'); ?>">
                <i class="icon-base ti tabler-<?php echo e($step5Done ? 'check' : 'circle'); ?>"></i>
              </div>
              <div class="ps-2">
                <h6 class="mb-1 text-white" style="font-size: 0.95rem;">Tahap 5: Dokumen &amp; Pertanyaan</h6>
                <p class="text-body-premium mb-0 small" style="font-size: 0.75rem;">
                  <?php echo e($step5Done ? 'Selesai diisi' : 'Belum selesai'); ?>
            ...
            <div class="timeline-item-premium">
              <div class="timeline-badge-premium <?php echo e($step6Done ? 'completed' : 'pending'); ?>">
                <i class="icon-base ti tabler-<?php echo e($step6Done ? 'check' : 'circle'); ?>"></i>
              </div>
              <div class="ps-2">
                <h6 class="mb-1 text-white" style="font-size: 0.95rem;">Tahap 6: Review &amp; Kirim</h6>
                <p class="text-body-premium mb-0 small" style="font-size: 0.75rem;">
                  <?php echo e($step6Done ? 'Sudah Submit Final' : 'Belum disubmit'); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $enrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="mb-3 pb-3" style="border-bottom: 1px solid rgba(255,255,255,0.06);">
                <div class="d-flex justify-content-between align-items-start mb-2">
                  <div>
                    <div class="fw-semibold text-white" style="font-size: 0.9rem;"><?php echo e($enrollment->pelatihan->nama); ?></div>
                    <div class="text-body-premium" style="font-size: 0.7rem;">Batch: <?php echo e($enrollment->pelatihan->batch); ?></div>
                  </div>
                  <div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($enrollment->status):
                      case ('pending'): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($enrollment->notes): ?>
                  <div class="text-body-premium mb-2" style="font-size: 0.75rem; font-style: italic;">
                    <i class="icon-base ti tabler-message"></i> <?php echo e($enrollment->notes); ?>
                ...
                <div class="d-flex gap-2 flex-wrap mt-2">
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($enrollment->status?->value === 'pending'): ?>
                    ...
                    <form action="<?php echo e(route('admin.enrollments.waitlist', $enrollment)); ?>" method="POST" class="d-inline">
                      <?php echo csrf_field(); ?>
                    ...
                    <button type="button" class="btn btn-danger btn-action d-inline-flex align-items-center gap-1" style="border-radius: 5px;" data-bs-toggle="modal" data-bs-target="#rejectEnrollmentModal" data-enrollment-id="<?php echo e($enrollment->id); ?>" data-enrollment-route="<?php echo e(route('admin.enrollments.reject', $enrollment)); ?>">
                      <i class="icon-base ti tabler-x fs-6"></i> Tolak
                    </button>

                  <?php elseif($enrollment->status?->value === 'waitlist'): ?>
                    <form action="<?php echo e(route('admin.enrollments.promote', $enrollment)); ?>" method="POST" class="d-inline">
                      <?php echo csrf_field(); ?>
                      <button type="submit" class="btn btn-success btn-action d-inline-flex align-items-center gap-1" style="border-radius: 5px;">
                  ...
                  <?php elseif($enrollment->status?->value === 'approved'): ?>
                    <form action="<?php echo e(route('admin.enrollments.reset', $enrollment)); ?>" method="POST" class="d-inline reset-enrollment-form" data-name="<?php echo e($peserta->name); ?>" data-pelatihan="<?php echo e($enrollment->pelatihan->nama); ?>">
                      <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/admin/peserta/show.blade.php ENDPATH**/ ?>