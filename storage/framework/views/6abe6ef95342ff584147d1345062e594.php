...
<?php $__env->startSection('title', 'Pengaturan Mode Maintenance'); ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($maintenanceActive): ?>
      ...
      <div class="glass-card-premium px-4 px-xl-5 py-5">
        <form action="<?php echo e(route('admin.settings.maintenance.update')); ?>" method="POST">
          ...
          <div class="maintenance-toggle-wrapper mb-4">
            <div class="form-check form-switch mb-0" style="padding-left: 3.5em;">
              ...
              <input class="form-check-input maintenance-toggle" type="checkbox" role="switch"
                ...
                <?php echo e($maintenanceActive ? 'checked' : ''); ?>>
            </div>
            <div>
          ...
          <div class="mb-4">
            ...
            <input type="text" class="form-control <?php $__errorArgs = ['maintenance_title'];
...
unset($__errorArgs, $__bag); ?>"
              ...
              value="<?php echo e(old('maintenance_title', $settings['maintenance_title']->value ?? 'Sistem Sedang Dalam Pemeliharaan')); ?>"
              placeholder="Sistem Sedang Dalam Pemeliharaan" required>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['maintenance_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div class="mb-4">
            ...
            <textarea class="form-control <?php $__errorArgs = ['maintenance_message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
              ...
              placeholder="Kami sedang melakukan pemeliharaan rutin untuk meningkatkan layanan. Silakan kembali lagi nanti."><?php echo e(old('maintenance_message', $settings['maintenance_message']->value ?? 'Kami sedang melakukan pemeliharaan rutin untuk meningkatkan layanan. Silakan kembali lagi nanti.')); ?></textarea>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['maintenance_message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div class="mb-4">
            ...
            <input type="text" class="form-control <?php $__errorArgs = ['maintenance_estimated_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
              ...
              value="<?php echo e(old('maintenance_estimated_time', $settings['maintenance_estimated_time']->value ?? '')); ?>"
              placeholder="Contoh: Pukul 16.00 WIB atau 2 Jam lagi">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['maintenance_estimated_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/admin/branding/maintenance.blade.php ENDPATH**/ ?>