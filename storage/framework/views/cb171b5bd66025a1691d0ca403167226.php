...
<?php $__env->startSection('title', 'Form Pendaftaran Peserta'); ?>
    ...
    <form id="formPeserta" @submit.prevent="submitForm()">
      ...
      <div class="tab-pane-step">
        ...
        <div class="field-group">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('nama_lengkap', $dpActive)): ?>
          <div>
            <label class="form-label form-label-custom" for="nama_lengkap">
              <?php echo e($dpLabels['nama_lengkap'] ?? 'Nama Lengkap Sesuai KTP'); ?>

              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('nama_lengkap', $dpRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </label>
            <input type="text" id="nama_lengkap" name="nama_lengkap" class="form-control form-control-custom form-control-uppercase"
              x-model="form.nama_lengkap" placeholder="<?php echo e($dpPlaceholders['nama_lengkap'] ?? 'NAMA LENGKAP SESUAI KTP'); ?>"
          ...
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('nik', $dpActive)): ?>
          <div>
            <label class="form-label form-label-custom" for="nik">
              <?php echo e($dpLabels['nik'] ?? 'NIK KTP'); ?>

              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('nik', $dpRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </label>
            <input type="text" id="nik" name="nik" class="form-control form-control-custom"
              x-model="form.nik" placeholder="<?php echo e($dpPlaceholders['nik'] ?? '15-16 DIGIT NIK'); ?>" maxlength="16"
        ...
        <!-- Jenis Kelamin -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('jenis_kelamin', $dpActive)): ?>
        <div class="field-group mt-3">
          <div class="field-full">
            <label class="form-label form-label-custom">
              <?php echo e($dpLabels['jenis_kelamin'] ?? 'Jenis Kelamin'); ?>

              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('jenis_kelamin', $dpRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </label>
        ...
        <div class="field-group mt-3">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('tempat_lahir', $dpActive)): ?>
          <div>
            <label class="form-label form-label-custom" for="tempat_lahir">
              <?php echo e($dpLabels['tempat_lahir'] ?? 'Tempat Lahir'); ?>

              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('tempat_lahir', $dpRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </label>
            <input type="text" id="tempat_lahir" name="tempat_lahir" class="form-control form-control-custom form-control-uppercase"
              x-model="form.tempat_lahir" placeholder="<?php echo e($dpPlaceholders['tempat_lahir'] ?? 'JAKARTA'); ?>"
          ...
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('tanggal_lahir', $dpActive)): ?>
          <div>
            <label class="form-label form-label-custom" for="tanggal_lahir">
              <?php echo e($dpLabels['tanggal_lahir'] ?? 'Tanggal Lahir'); ?>

              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('tanggal_lahir', $dpRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </label>
            <select id="tanggal_lahir" name="tanggal_lahir" class="form-control form-control-custom" x-model="form.tanggal_lahir"
              ...
              <option value="" disabled><?php echo e($dpPlaceholders['tanggal_lahir'] ?? 'PILIH TANGGAL'); ?></option>
          ...
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('bulan_lahir', $dpActive)): ?>
          <div>
            <label class="form-label form-label-custom" for="bulan_lahir">
              <?php echo e($dpLabels['bulan_lahir'] ?? 'Bulan Lahir'); ?>

              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('bulan_lahir', $dpRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </label>
            <select id="bulan_lahir" name="bulan_lahir" class="select2 form-select form-control form-control-custom form-control-uppercase" x-model="form.bulan_lahir"
              ...
              <option value="" disabled><?php echo e($dpPlaceholders['bulan_lahir'] ?? 'PILIH BULAN'); ?></option>
          ...
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('tahun_lahir', $dpActive)): ?>
          <div>
            <label class="form-label form-label-custom" for="tahun_lahir">
              <?php echo e($dpLabels['tahun_lahir'] ?? 'Tahun Lahir'); ?>

              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('tahun_lahir', $dpRequired)): ?> <span class="text-danger">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </label>
            <select id="tahun_lahir" name="tahun_lahir" class="select2 form-select form-control form-control-custom" x-model="form.tahun_lahir"
              ...
              <option value="" disabled><?php echo e($dpPlaceholders['tahun_lahir'] ?? 'PILIH TAHUN'); ?></option>
    ...
    Alpine.data('dataPribadiForm', function() {
      ...
      return {
        ...
        submitForm() {
          ...
          fetch('<?php echo e(route('dashboard.peserta.save-tab1')); ?>', {
            method: 'POST',
            body: formData
          })
          .then(function(res) {
            ...
            .then(function(data) {
              if (data.success) {
                self.saving = false;
                window.location.href = "<?php echo e(route('dashboard.peserta.form-alamat')); ?>";
              } else {
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Pelatihanku\resources\views/content/dashboard/peserta/form-pendaftaran.blade.php ENDPATH**/ ?>