...
class Helpers
{
  ...
  public static function appClasses()
  {
    ...
    $allOptions = [
      ...
      'myTheme' => ['light', 'dark', 'system', 'beranda'],
      'mySkins' => ['default', 'bordered', 'premium'],
    ...
    // Handle beranda theme: treat as dark mode
    if ($data['myTheme'] === 'beranda') {
      $themeVal = 'dark';
      $themeUpdatedVal = 'beranda';
    } else {
