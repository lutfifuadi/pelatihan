        ...
        <div class="card border-0 shadow-lg text-white" style="background: rgba(30, 41, 59, 0.65); backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px); border-radius: 16px; border: 1px solid rgba(255, 255, 255, 0.08);">
          <div class="card-body p-4 p-md-5">
            ...
            <div class="text-white-50" style="line-height: 1.7; font-size: 0.975rem; color: rgba(255, 255, 255, 0.7) !important;">
              ...
              <h5 class="mt-4 fw-bold text-warning" style="font-family: 'Sora', sans-serif;">A. Kemitraan Resmi dengan Pemerintah Kota Bandung melalui Dinas-Dinas Penyelenggara Pelatihan terkait</h5>
              <p>Platform <strong class="text-white">pelatihanku.my.id</strong> dikelola dan dioperasikan dalam rangka kemitraan resmi dengan <strong class="text-white">Pemerintah Kota Bandung melalui Dinas-Dinas Penyelenggara Pelatihan terkait</strong> untuk memfasilitasi program pelatihan, peningkatan kapasitas, serta pengembangan kompetensi masyarakat di sektor kebudayaan dan pariwisata. Seluruh proses pengolahan data dalam platform ini diselaraskan dengan kebutuhan administratif kepesertaan pelatihan resmi yang diselenggarakan oleh Pemerintah Kota Bandung melalui Dinas-Dinas Penyelenggara Pelatihan terkait.</p>
              ...
              <ol>
                <li><strong class="text-white">Syarat Administrasi Keikutsertaan</strong>: Sebagai program resmi yang diselenggarakan oleh instansi pemerintah (Pemerintah Kota Bandung melalui Dinas-Dinas Penyelenggara Pelatihan terkait), NIK diperlukan untuk memenuhi keabsahan administrasi pertanggungjawaban program pelatihan yang dibiayai atau didukung oleh anggaran daerah.</li>
                ...
                <li><strong class="text-white">Sinkronisasi Data dengan Sistem Database Terpadu</strong>: Data NIK diperlukan untuk melakukan integrasi dan sinkronisasi dengan <strong class="text-white">sistem database terpadu milik Dinas Penyelenggara terkait (seperti Newbimma untuk Dinas Kebudayaan dan Pariwisata, atau sistem database kepesertaan dinas terkait lainnya)</strong>. Sinkronisasi ini bertujuan untuk menghindari duplikasi kepesertaan, mencatat riwayat pelatihan warga secara berkelanjutan, dan memastikan transparansi serta akuntabilitas program pembinaan masyarakat.</li>
              </ol>
              ...
              <ul>
                <li><strong class="text-white">Tujuan Khusus</strong>: Data Pribadi Anda dikumpulkan dan diolah <strong class="text-white">murni untuk keperluan administratif, koordinasi, pelaksanaan, dan pelaporan program pelatihan</strong> yang diselenggarakan bersama Pemerintah Kota Bandung melalui Dinas-Dinas Penyelenggara Pelatihan terkait.</li>
                <li><strong class="text-white">Tidak untuk Disebarluaskan/Dijual</strong>: Kami menjamin bahwa Data Pribadi Anda tidak akan disebarluaskan, diperjualbelikan, atau diserahkan kepada pihak ketiga mana pun di luar kemitraan resmi Pemerintah Kota Bandung melalui Dinas-Dinas Penyelenggara Pelatihan terkait tanpa persetujuan eksplisit dari Anda, kecuali jika diwajibkan oleh hukum atau putusan pengadilan yang sah.</li>
              </ul>
              ...
              <ol>
                ...
                <li><strong class="text-white">Hak Menarik Persetujuan dan Penghapusan Data (Right to Erasure)</strong>: Setelah program pelatihan selesai dilaksanakan dan seluruh proses pelaporan administratif wajib kepada Pemerintah Kota Bandung melalui Dinas-Dinas Penyelenggara Pelatihan terkait terpenuhi, Anda berhak mengajukan permohonan untuk menarik persetujuan pengolahan data serta meminta penghapusan permanen atas data pribadi Anda (termasuk NIK) dari database aktif pelatihanku.my.id.</li>
              </ol>
