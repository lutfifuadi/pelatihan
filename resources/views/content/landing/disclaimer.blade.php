        ...
        <div class="card border-0 shadow-lg text-white" style="background: rgba(30, 41, 59, 0.65); backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px); border-radius: 16px; border: 1px solid rgba(255, 255, 255, 0.08);">
          <div class="card-body p-4 p-md-5">
            ...
            <div class="text-white-50" style="line-height: 1.7; font-size: 0.975rem; color: rgba(255, 255, 255, 0.7) !important;">
              ...
              <p>Platform <strong class="text-white">pelatihanku.my.id</strong> merupakan platform kemitraan resmi yang ditunjuk dan disetujui oleh <strong class="text-white">Pemerintah Kota Bandung melalui Dinas-Dinas Penyelenggara Pelatihan terkait</strong> untuk menyelenggarakan pendaftaran, manajemen peserta, dan fasilitasi proses belajar-mengajar dalam program pelatihan kerja sama. Platform ini bertindak sebagai perantara sistem informasi digital guna mendukung kelancaran program-program pembinaan yang dicanangkan oleh Pemerintah Kota Bandung melalui Dinas-Dinas Penyelenggara Pelatihan terkait.</p>
              ...
              <p>Kami mengimbau kepada seluruh calon peserta, peserta aktif, maupun alumni pelatihan untuk senantiasa waspada terhadap segala bentuk modus penipuan yang mencatut nama program pelatihan Pemerintah Kota Bandung melalui Dinas-Dinas Penyelenggara Pelatihan terkait atau platform pelatihanku.my.id.</p>
              ...
              <ol>
                ...
                <li><strong class="text-white">Konfirmasi Informasi</strong>: Apabila Anda dihubungi oleh pihak yang mengaku sebagai panitia, perwakilan Pemerintah Kota Bandung melalui Dinas-Dinas Penyelenggara Pelatihan terkait, atau admin pelatihanku.my.id dengan nomor yang berbeda dari nomor resmi di atas, atau jika pihak tersebut meminta imbalan uang/barang, harap segera mengabaikan pesan tersebut dan melaporkannya kepada kami melalui menu pengaduan resmi di platform.</li>
