...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row mb-4 align-items-center">
        ...
        <div class="col-md-6 text-md-end mt-3 mt-md-0">
            <a href="{{ route('notifications.index') }}" class="filter-btn" style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); color: #b0b4c2; border-radius: 5px; padding: 8px 18px; font-size: 13px; text-decoration: none;">
    ...
    <form action="{{ route('notifications.preferences.update') }}" method="POST">
            ...
            <div class="d-flex align-items-center justify-content-between py-3 px-3 rounded-3 mb-3"
                ...
                <div class="form-check form-switch mb-0">
                    ...
                    <input class="form-check-input" type="checkbox" name="in_app_enabled" value="1"
                        id="in_app_enabled" {{ $preferences->in_app_enabled ? 'checked' : '' }}>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between py-3 px-3 rounded-3 mb-3"
                ...
                <div class="form-check form-switch mb-0">
                    ...
                    <input class="form-check-input" type="checkbox" name="whatsapp_enabled" value="1"
                        id="whatsapp_enabled" {{ $preferences->whatsapp_enabled ? 'checked' : '' }}>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between py-3 px-3 rounded-3"
                ...
                <div class="form-check form-switch mb-0">
                    ...
                    <input class="form-check-input" type="checkbox" name="email_enabled" value="1"
                        id="email_enabled" {{ $preferences->email_enabled ? 'checked' : '' }}>
                </div>
            </div>
        </div>
        ...
        <div class="pref-card mb-4">
            ...
            <div x-data="{ quietEnabled: {{ ($preferences->quiet_hours_start && $preferences->quiet_hours_end) ? 'true' : 'false' }} }">
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('preferencesForm', () => ({
            quietEnabled: {{ ($preferences->quiet_hours_start && $preferences->quiet_hours_end) ? 'true' : 'false' }}
        }));
    });
</script>
@endsection
