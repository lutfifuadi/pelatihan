...
<div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
  ...
  {{-- ============================================================
       RIWAYAT SELURUH PENDAFTARAN PELATIHAN
       ============================================================ --}}
  @if(isset($allEnrollments) && $allEnrollments->count() > 0)
  <div class="glass-card-premium p-4 p-xl-4 mt-4">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
      <h5 class="fw-bold text-white mb-0 d-flex align-items-center gap-2">
        ...
        Riwayat Seluruh Pendaftaran Anda
      </h5>
      <span class="badge" style="background: rgba(99, 102, 241, 0.18); border: 1px solid rgba(99, 102, 241, 0.35); color: #c7d2fe; border-radius: 5px !important; padding: 4px 10px; font-weight: 600; font-size: 0.75rem;">
        Total: {{ $allEnrollments->count() }} Pendaftaran
      </span>
    </div>

    <div class="row g-3">
      @foreach($allEnrollments as $idx => $histEnr)
        @php
          $histPelatihan = $histEnr->pelatihan;
          $isCurrent = ($enrollment && $enrollment->id === $histEnr->id);
        @endphp
        <div class="col-12 col-lg-6">
          <div class="p-3.5 h-100 d-flex flex-column justify-content-between" style="background: rgba(255, 255, 255, 0.03); border: 1px solid {{ $isCurrent ? 'rgba(99, 102, 241, 0.4)' : 'rgba(255, 255, 255, 0.07)' }}; border-radius: 5px !important; position: relative;">
            @if($isCurrent)
