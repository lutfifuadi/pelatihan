              ...
              <template x-if="batchList.length === 0">
                <div class="empty-state-container text-center py-5 px-3">
                  ...
                  <p class="text-body-premium mb-3 px-4" style="max-width: 600px; margin: 0 auto; font-size: 0.95rem; line-height: 1.7;">
                    Hai <span class="fw-semibold text-white">{{ auth()->user()->name }}</span>, 
                  ...
                  <div class="d-flex flex-wrap justify-content-center gap-3 mt-3">
                    <a :href="'https://wa.me/' + adminWa + '?text=' + encodeURIComponent('Halo admin, saya ' + '{{ auth()->user()->name }}' + ' dari ' + (userLocation?.kecamatan || '') + '. Apakah ada informasi pelatihan terbaru untuk wilayah saya?')"
                       target="_blank"
