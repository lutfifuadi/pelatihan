    ...
    <div class="glass-card-premium px-4 px-xl-5 py-4 mb-4">
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <ul class="nav nav-pills gap-1">
          <li class="nav-item">
            <a class="nav-link text-white-50" href="{{ route('admin.settings.branding') }}" style="border-radius: 8px; font-weight: 500;">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="{{ route('admin.settings.maintenance') }}" style="border-radius: 8px; font-weight: 500;">
