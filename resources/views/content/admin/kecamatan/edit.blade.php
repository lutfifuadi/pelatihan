  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
    ...
    <div class="glass-card-premium px-4 px-xl-5 py-4 mb-4">
      <div class="d-flex align-items-center gap-3">
        ...
        <div>
          <h4 class="fw-bold text-white mb-0">Edit Kecamatan</h4>
          <p class="text-body-premium mb-0 mt-1" style="font-size: 0.95rem;">
            Perbarui data kecamatan: {{ $kecamatan->name }}
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="col-12">
      <div class="glass-card-premium px-4 px-xl-5 py-5">
        <form action="{{ route('admin.kecamatan.update', $kecamatan) }}" method="POST">
          ...
          <!-- Nama Kecamatan -->
          <div class="mb-4">
            <label for="name" class="form-label">Nama Kecamatan <span class="text-danger">*</span></label>
            <input type="text" class="form-control @error('name') is-invalid @enderror"
              id="name" name="name" value="{{ old('name', $kecamatan->name) }}" placeholder="Masukkan nama kecamatan" required>
            @error('name')
          ...
          <div class="d-flex justify-content-end gap-3 mt-5">
            <a href="{{ route('admin.kecamatan.index') }}" class="btn btn-secondary-custom px-4 py-2">
              Batal
            </a>
