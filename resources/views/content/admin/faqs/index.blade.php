  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
    ...
    <div class="glass-card-premium px-4 px-xl-5 py-4 mb-4">
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <a href="{{ route('admin.faqs.create') }}" class="btn btn-glow-premium px-4 py-2 d-flex align-items-center gap-2">
            ...
            <tbody>
              @forelse($faqs as $index => $faq)
                <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.04);">
                  ...
                  <td class="py-3">
                    <span class="badge-premium">{{ $faq->order }}</span>
                  </td>
                  <td class="py-3 text-white fw-semibold">{{ \Illuminate\Support\Str::limit($faq->question, 60) }}</td>
                  <td class="py-3">
                    @if($faq->is_active)
                  ...
                  <td class="text-end px-0 py-3">
                    <div class="d-inline-flex gap-2">
                      <a href="{{ route('admin.faqs.edit', $faq) }}" class="btn btn-warning btn-sm d-flex align-items-center justify-content-center" style="border-radius: 5px; width: 32px; height: 32px; padding: 0;">
