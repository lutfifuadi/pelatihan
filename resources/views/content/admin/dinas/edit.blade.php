  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
    ...
    <div class="glass-card-premium px-4 px-xl-5 py-4 mb-4">
      <div class="d-flex align-items-center gap-3">
        ...
        <div>
          <h4 class="fw-bold text-white mb-0">Edit Dinas</h4>
          <p class="text-body-premium mb-0 mt-1" style="font-size: 0.95rem;">
            Perbarui data dinas/instansi: {{ $dinas->nama_dinas }}
          </p>
        </div>
      </div>
    </div>
        ...
        <form action="{{ route('admin.dinas.update', $dinas) }}" method="POST">
          ...
          <div class="mb-4">
            ...
            <input type="text" class="form-control @error('nama_dinas') is-invalid @enderror"
              id="nama_dinas" name="nama_dinas" value="{{ old('nama_dinas', $dinas->nama_dinas) }}" placeholder="Masukkan nama dinas" required>
            @error('nama_dinas')
          ...
          <div class="mb-4">
            <div class="form-check d-flex align-items-center gap-2">
              ...
              <input type="checkbox" class="form-check-input @error('is_active') is-invalid @enderror"
                id="is_active" name="is_active" value="1" {{ old('is_active', $dinas->is_active) ? 'checked' : '' }}>
              <label class="form-check-label text-white-50 ms-1 mb-0" for="is_active" style="cursor: pointer; font-size: 13px;">Status Dinas Aktif</label>
              @error('is_active')
                <div class="invalid-feedback mt-1">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="d-flex justify-content-end gap-3 mt-5">
            <a href="{{ route('admin.dinas.index') }}" class="btn btn-secondary-custom px-4 py-2">
              Batal
            </a>
