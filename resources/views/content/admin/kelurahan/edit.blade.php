  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
    ...
    <div class="glass-card-premium px-4 px-xl-5 py-4 mb-4">
      <div class="d-flex align-items-center gap-3">
        ...
        <div>
          <h4 class="fw-bold text-white mb-0">Edit Kelurahan</h4>
          <p class="text-body-premium mb-0 mt-1" style="font-size: 0.95rem;">
            Perbarui data kelurahan: {{ $kelurahan->name }}
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="col-12">
      <div class="glass-card-premium px-4 px-xl-5 py-5">
        <form action="{{ route('admin.kelurahan.update', $kelurahan) }}" method="POST">
          @csrf
          @method('PUT')

          <!-- Nama Kelurahan -->
          <div class="mb-4">
            <label for="name" class="form-label">Nama Kelurahan <span class="text-danger">*</span></label>
            <input type="text" class="form-control @error('name') is-invalid @enderror"
              id="name" name="name" value="{{ old('name', $kelurahan->name) }}" placeholder="Masukkan nama kelurahan" required>
            @error('name')
          ...
          <div class="mb-4">
            <div class="form-check">
              <input type="checkbox" class="form-check-input" id="active" name="active" value="1" {{ old('active', $kelurahan->active ?? true) ? 'checked' : '' }}>
          ...
          <div class="d-flex justify-content-end gap-3 mt-5">
            <a href="{{ route('admin.kelurahan.index') }}" class="btn btn-secondary-custom px-4 py-2">
              Batal
            </a>
