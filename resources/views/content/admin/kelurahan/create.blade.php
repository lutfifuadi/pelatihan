  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
    ...
    <div class="glass-card-premium px-4 px-xl-5 py-4 mb-4">
      <div class="d-flex align-items-center gap-3">
        ...
        <div>
          <h4 class="fw-bold text-white mb-0">Tambah Kelurahan</h4>
          <p class="text-body-premium mb-0 mt-1" style="font-size: 0.95rem;">
            Buat data kelurahan baru
          </p>
        </div>
      </div>
    </div>
        ...
        <form action="{{ route('admin.kelurahan.store') }}" method="POST">
          ...
          <div class="mb-4">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror"
              id="name" name="name" value="{{ old('name') }}" placeholder="Masukkan nama kelurahan" required>
            @error('name')
