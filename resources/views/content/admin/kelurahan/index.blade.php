  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;" id="kelurahan-page">
    ...
    <div class="glass-card-premium px-4 px-xl-5 py-4 mb-4">
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <a href="{{ route('admin.kelurahan.create') }}" class="btn btn-glow-premium px-4 py-2 d-flex align-items-center gap-2">
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="position-relative flex-grow-1">
            ...
            <input type="text" id="search-input"
              class="form-control" placeholder="Cari nama kelurahan..." value="{{ $search ?? '' }}" style="padding-left: 2.5rem !important; border-radius: 5px;">
          </div>
          <a href="{{ route('admin.kelurahan.index') }}" id="reset-btn" class="btn btn-secondary-custom px-3 py-2 {{ request()->has('search') && request('search') != '' ? '' : 'd-none' }}" style="white-space: nowrap;">
        ...
        <div class="table-responsive">
          <table class="table table-borderless text-white align-middle">
            ...
            <tbody id="table-content">
              @include('content.admin.kelurahan._table_rows')
            </tbody>
          </table>
        </div>
        <!-- Pagination -->
