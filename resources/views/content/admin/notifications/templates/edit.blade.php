...
@section('title', 'Edit Template Notifikasi')
  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
    ...
    <div class="glass-card-premium px-4 px-xl-5 py-4 mb-4">
      <div class="d-flex align-items-center gap-3">
        ...
        <div>
          <h4 class="fw-bold text-white mb-0">Edit Template: {{ $template->name }}</h4>
            ...
            <form action="{{ route('admin.notification-templates.update', $template) }}" method="POST">
              ...
              <div class="mb-4">
                ...
                <input type="text" class="form-control @error('key') is-invalid @enderror"
                  id="key" name="key" value="{{ old('key', $template->key) }}"
              ...
              <div class="mb-4">
                ...
                <textarea class="form-control @error('body') is-invalid @enderror"
                  ...
                  placeholder="Tulis isi pesan. Gunakan {placeholder} untuk variabel dinamis." required>{{ old('body', $template->body) }}</textarea>
                @error('body')
                  <div class="invalid-feedback mt-1">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="row mb-4">
                <div class="col-md-6 mb-3 mb-md-0">
                  ...
                  <select class="form-select @error('channel') is-invalid @enderror" id="channel" name="channel" required>
                    ...
                    <option value="in_app" @selected(old('channel', $template->channel) == 'in_app')>In-App</option>
                  </select>
                  @error('channel')
                    <div class="invalid-feedback mt-1">{{ $message }}</div>
                  @enderror
