...
@section('title', 'Tambah Pengumuman Pelatihan')
  ...
  <div class="container-fluid px-4 px-lg-6 position-relative" style="z-index: 1;">
    ...
    <div class="glass-card-premium px-4 px-xl-5 py-4 mb-4">
      <div class="d-flex align-items-center gap-3">
        ...
        <div>
          <h4 class="fw-bold text-white mb-0">Tambah Pengumuman Baru</h4>
          <p class="text-body-premium mb-0 mt-1" style="font-size: 0.95rem;">
            Buat pengumuman baru untuk pelatihan tertentu atau untuk semua pelatihan
          </p>
        </div>
      </div>
    </div>
          ...
          <div class="mb-4">
            ...
            <select name="pelatihan_id" id="pelatihan_id" class="select2 form-select @error('pelatihan_id') is-invalid @enderror" data-placeholder="-- Pilih Pelatihan (Global) --">
              ...
              @foreach($pelatihans as $pelatihan)
                <option value="{{ $pelatihan->id }}" {{ old('pelatihan_id') == $pelatihan->id ? 'selected' : '' }} style="background-color: #0b0f19; color: white;">
