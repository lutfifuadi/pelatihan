      ...
      <div class="card-body">
        <form action="{{ route('admin.kta-members.update', $ktaMember->id) }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-uppercase @error('nama_lengkap') is-invalid @enderror" id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap', $ktaMember->nama_lengkap) }}" oninput="this.value = this.value.toUpperCase()" required>
