@if(session()->has('impersonator_id'))
  <div style="position: fixed; top: 0; left: 0; right: 0; z-index: 9999; background: linear-gradient(90deg, #b45309, #d97706); color: #fff; padding: 10px 20px; font-family: 'Sora', sans-serif; box-shadow: 0 4px 15px rgba(0,0,0,0.3); border-bottom: 2px solid #fbbf24;">
