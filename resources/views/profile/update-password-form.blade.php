    ...
    <div class="mb-5 form-password-toggle">
      ...
      <div class="input-group input-group-merge">
        <x-input id="current_password" type="password" class="{{ $errors->has('current_password') ? 'is-invalid' : '' }}"
          wire:model="state.current_password" autocomplete="current-password" style="border-right: 0;" />
    ...
    <div class="mb-6 form-password-toggle">
      ...
      <div class="input-group input-group-merge">
        <x-input id="password" type="password" class="{{ $errors->has('password') ? 'is-invalid' : '' }}"
          wire:model="state.password" autocomplete="new-password" style="border-right: 0;" />
        <span class="input-group-text cursor-pointer" style="border-left: 0; background-color: inherit; padding-left: 10px;"><i class="icon-base ti tabler-eye-off"></i></span>
      </div>
    ...
    <div class="mb-6 form-password-toggle">
      ...
      <div class="input-group input-group-merge">
        <x-input id="password_confirmation" type="password"
          ...
          autocomplete="new-password" style="border-right: 0;" />
        <span class="input-group-text cursor-pointer" style="border-left: 0; background-color: inherit; padding-left: 10px;"><i class="icon-base ti tabler-eye-off"></i></span>
      </div>
